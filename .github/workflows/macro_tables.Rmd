...
HICP_QUARTERLY_FULL_YTD<-rbind(YTD(as.xts(as.numeric(HICP_QUARTERLY["/2023"]),order.by = as.Date(as.character.Date(HICP_QUARTERLY["/2023"])))),YTD(as.xts(as.numeric(HICP_QUARTERLY),order.by = as.Date(as.character.Date(HICP_QUARTERLY)))))
...
Deflated_VAT_Quarterly_GROWTH<-((1+(VAT_XTS_Quarterly_GROWTH["2023/"]/100))/(1+(HICP_QUARTERLY_FULL_YTD/100))-1)*100
