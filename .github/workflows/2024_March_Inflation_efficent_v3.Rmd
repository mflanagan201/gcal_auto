...
#rename column 
names(CORE_SERVICES_WEIGHT)[names(CORE_SERVICES_WEIGHT) == 'A.CP0830.IE'] <- 'CP082_3'
names(CORE_SERVICES_WEIGHT_XTS)[names(CORE_SERVICES_WEIGHT_XTS) == 'A.CP0830.IE'] <- 'CP082_3'

names(CORE_SERVICES_WEIGHT)[names(CORE_SERVICES_WEIGHT) == 'A.CP0322.IE'] <- 'CP0322a'
names(CORE_SERVICES_WEIGHT_XTS)[names(CORE_SERVICES_WEIGHT_XTS) == 'A.CP0322.IE'] <- 'CP0322a'
