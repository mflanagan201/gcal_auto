...
SERVICES_TEXT_2_NAME<-names(SERVICES_MAIN_COMPONENTS[,1]) %>% gsub(
 ...
 name_text_services<-conditional(as.numeric(GROWTH_COMPONENTS_XTS[nrow(GROWTH_COMPONENTS_XTS),SERVICES_TEXT_2_NAME]))
...
* The growth in service prices was driven by `r SERVICES_TEXT_2_NAME` which `r name_text_services`  
<br>
<br>
