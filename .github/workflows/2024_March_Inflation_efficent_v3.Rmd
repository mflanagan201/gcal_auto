...
FORECAST_KPI<-YTD_2024_annual-1.7
...
* As part of Budget 2025, the Department forecast Inflation growth of 1.7% in 2024. Year to date, annual inflation is averaging `r YTD_2024_annual`% in `r CURRENT_DATE`. As a result inflation is currently running `r FORECAST_KPI_TEXT`. 
<br>
<br>
...
#contribution to overall inflation rate bar chart
CONTRIBUTION_df <- data.frame(CONTRIBUTION["2022/"])
...
Overall_energy_contribution_line<- data.frame(index(ENERGY["2022/"]), ENERGY["2022/"])
