...
inflationbreakdown<-data.frame(index(below_zero_xts["2022/"]),below_zero_xts["2022/"],betweeen_zero_two_xts["2022/"],betweeen_two_five_xts["2022/"],over_five_xts["2022/"])
...
infl_CONTR<-data.frame(inflationbreakdown[14:nrow(inflationbreakdown),],over_five_12_Months_SUM["2023-02-01/"])
...
```{r contribution EA inflation, echo=FALSE, mess0age=FALSE, warning=FALSE}
#EURO AREA 
...
EA_DIFFERENCE<-data.frame(index(NEW_CORE_SERVICES_EA["2019/"]),Graph_Data_EA,EA_INFLATION_XTS["2019/"])
...
MEGA_DATA_DOWNLOAD <- list('HICP_INDEX_LEVEL' =data.frame(INDEX_VALUES),'ANNUAL GROWTH'=data.frame(ANNUAL_GROWTH),'CONTRIBUTION' =data.frame(index(HICP_INDEX_XTS["2019/"]),CONTRIBUTION),'Contribution Services'=SERVICES_CONTRIBUTION_OUTPUT,'Contribution Energy'=ENergy_CONTRIBUTIONS)
