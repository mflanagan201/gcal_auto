...
withr::with_options(
  list(ggplot2.discrete.colour = DOF_colours),
...
HICP_WEIGHT_NAMES<-c("A.CP0111.IE",
"A.CP0112.IE",
"A.CP0113.IE",
"A.CP0114.IE",
"A.CP0115.IE",
...
CONTRIBUTION[is.na(CONTRIBUTION)]<-0
  ...
  INDO_WEIGHT_2_YEAR_AGO<-lag.xts(Weight[,i],12) %>% .[13:length(.)] %>% as.numeric()   %>%as.xts(order.by=index(Overall["2018/"]))/1000
  INDO_DEC_1_YEAR_AGO<-((Indo["2017/"][paste0(year(Indo["2017/",i])-1, "-12-01"),i])) %>% as.numeric()  %>%as.xts(order.by=index(Overall["2018/"]))
  INDO_INDEX_1_YEAR_AGO<-lag.xts(Indo["2017/",i],12)  %>% .[13:length(.)] %>% as.numeric()  %>%as.xts(order.by=index(Overall["2018/"]))
  INDO_DEC_2_YEAR_AGO<-lag(INDO_DEC_1_YEAR_AGO,12)   %>% .[13:length(.)] %>% as.numeric()  %>%as.xts(order.by=index(Overall["2019/"]))
...
CONTRIBUTION<-(Contribution(OVERALL_HICP_XTS["2016/"],HICP_WEIGHT_XTS["2017/"],HICP_INDEX_XTS["2017/"])) 
...
ENERGY_INDEX_CONTRIBUTION<-rowSums(CHAIN_INDEX_ENERGY_CONTRIBUTION)*DEC_BASE_ENERGY[1:length(ENERGY_OVERALL_INDEX_XTS["2017/"])] 
...
ENergy_CONTRIBUTIONS<-data.frame(index(ENERGY_INDEX_OVERALL["2019/"]),ENERGY)  
colnames(ENergy_CONTRIBUTIONS)<- c("Date","Electricity","Gas","Liquid Fuel","Solid Fuels","Fuels & Lubricants for personal transport")
...
NEIG_WEIGHT_OVERALL<-c("A.IGD_NNRG.IE")
...
EXCLUDE_NEIG_WEIGHT_NAMES<-c("A.CP05512.IE","A.CP0931.IE","A.CP0935.IE","A.CP0322.IE")
...
NEIG_WEIGHT_XTS$CP055<-NEIG_WEIGHT_XTS$CP055-EXCLUDE_NEIG_WEIGHT_df$A.CP05512.IE
NEIG_WEIGHT_XTS$CP0934_5<-NEIG_WEIGHT_XTS$CP0934_5-EXCLUDE_NEIG_WEIGHT_df$A.CP0935.IE
NEIG_WEIGHT_XTS$CP0934_5 <-NEIG_WEIGHT_XTS$CP032-EXCLUDE_NEIG_WEIGHT_df$A.CP0322.IE
...
#NEIG_CONTRIBUTIONS<-Contribution(NEIG_INDEX_CONTRIBUTION_XTS_LONG["/2023"],NEIG_WEIGHT_XTS["/2023"],NEIG_INDEX_XTS["/2023"])
...
FOOD_WEIGHT_NAMES<-c("A.FOOD_NP.IE","A.FOOD_P_X_ALC_TBC.IE","A.CP011.IE","A.CP01.IE","A.CP02.IE")
...
UNPROCESSED_FOOD_CONTRIBUTION<-Chainlinking(UNPROCESSED_FOOD_INDEX)*(FOOD_WEIGHT_xTS$A.FOOD_NP.IE["2017/"]/FOOD_WEIGHT_xTS$A.CP01.IE["2017/"])*100
PROCESSED_FOOD_CONTRIBUTION<-(FOOD_INDEX-UNPROCESSED_FOOD_CONTRIBUTION)/(FOOD_WEIGHT_xTS$A.FOOD_P_X_ALC_TBC.IE["2017/"]/FOOD_WEIGHT_xTS$A.CP01.IE["2017/"])*100

PROCESSED_FOOD<-(as.numeric(FOOD_INDEX["2017/"])-((Chainlinking(UNPROCESSED_FOOD_INDEX)["2017/"])*as.numeric(FOOD_WEIGHT_xTS$A.FOOD_NP.IE["2017/"]/FOOD_WEIGHT_xTS$A.CP01.IE["2017/"])))
...
PROCESSED_FOOD_WEIGHT_NAMES<-c("A.CP0111.IE","A.CP01127.IE","A.CP01128.IE","A.CP01132.IE","A.CP01135.IE","A.CP01136.IE","A.CP01141.IE","A.CP01142.IE","A.CP01144.IE","A.CP01145.IE","A.CP01146.IE","A.CP0115.IE","A.CP01163.IE","A.CP01164.IE","A.CP01172.IE","A.CP01173.IE","A.CP01174.IE","A.CP01175.IE","A.CP0118.IE","A.CP0119.IE","A.CP0121.IE","A.CP0122.IE","A.CP0211.IE","A.CP0212.IE","A.CP0213.IE","A.CP022.IE")
...
Processed_FOOD_WEIGHT_XTS<-merge(PROCESSED_FOOD_WEIGHT_XTS$A.CP0111.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP01127.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP01128.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP01132.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP01135.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP01136.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP01141.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP01142.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP01144.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP01145.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP01146.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP0115.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP01163.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP01164.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP01172.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP01173.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP01174.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP01175.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP0118.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP0119.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP0121.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP0122.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP0211.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP0212.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP0213.IE,PROCESSED_FOOD_WEIGHT_XTS$A.CP022.IE)
...
SERVICES_WEIGHT_NAMES<-c("A.CP0322.IE","A.CP0830.IE")
...
SERVICES_INDEX_CONTRIBUTION_OVERALL_XTS["2017/"]<-rowSums(CHAIN_CORE_SERVICES_CONTRIBUTION)*DEC_BASE_SERVICES[1:length(SERVICES_OVERALL_INDEX_XTS["2017/"])]   
SERVICES_INDEX_CONTRIBUTION_OVERALL_XTS["2016"]<-SERVICES_OVERALL_INDEX_XTS["2016"]

SERVICES_CONTRIBUTION<-Contribution(SERVICES_INDEX_CONTRIBUTION_OVERALL_XTS,CORE_SERVICES_WEIGHT_XTS["2017/"],CORE_SERVICES_INDEX_XTS["2017/"])
...
write.xlsx(SERVICES_CONTRIBUTION,"SERVICES_CONTRIBUTION.xlsx")
...
summary_contribution<-data.frame(merge(NEIG["2020/"],FOOD["2020/"],ENERGY["2020/"],Rent["2020/"],CORE_SERVICES["2020/"]))
summary_contribution<-data.frame(summary_contribution,index(ENERGY["2020/"]))
...
min_waterfall<-latest_annual_Change_contributions$value[1]-abs(latest_annual_Change_contributions$value[2]+latest_annual_Change_contributions$value[3]+latest_annual_Change_contributions$value[4]+latest_annual_Change_contributions$value[5]+latest_annual_Change_contributions$value[6])
max_waterfall<-latest_annual_Change_contributions$value[1]+abs(latest_annual_Change_contributions$value[2]+latest_annual_Change_contributions$value[3]+latest_annual_Change_contributions$value[4]+latest_annual_Change_contributions$value[5]+latest_annual_Change_contributions$value[6])
...
conditional_alt4 <- function(x){
  if (x < 0) {
    print(paste(round(x,1), "percentage points below what was forecast at the time of SPU 2024"))
  } else if (x >0){
    print(paste(round(x,1), "percentage points above what was forecast at the time of SPU 2024"))
  } else {
    print(paste("inline with the SPU 2024 forecast"))
  }
}
...
YTD_2024_annual<-ANNUAL_INFLATION["2024/"] %>% mean()  %>% round(1)

FORECAST_KPI<-YTD_2024_annual-2.1
FORECAST_KPI_TEXT<-conditional_alt4(FORECAST_KPI)


carryover_weight<-(length(OVERALL_HICP_XTS["2024/"])/12)
Carryover<-((((as.numeric(OVERALL_HICP_XTS[length(OVERALL_HICP_XTS)])*(1-carryover_weight))+(mean(as.numeric(OVERALL_HICP_XTS["2024"]))*carryover_weight))-mean(as.numeric(OVERALL_HICP_XTS["2023"])))/mean(as.numeric(OVERALL_HICP_XTS["2023"])))*100 %>% as.numeric() 
...
* As part of SPU 2024, the Department forecast Inflation growth of 2.1% in 2024. Year to date, annual inflation is averaging `r YTD_2024_annual`% in `r CURRENT_DATE`. As a result inflation is currently running `r FORECAST_KPI_TEXT`. 
<br>
<br>

* On a carryover only basis, annual inflation is currently running at `r Carryover_TEXT` for 2024.  
<br>
<br>
...
LINE_DATA<-data.frame(index(ANNUAL_INFLATION["2020/"]),ANNUAL_INFLATION["2020/"])
...
Inflation_contributions_graph_data_XTS<-data.frame(index(ANNUAL_INFLATION["2020/"]),Inflation_contributions_graph_data) 
colnames(Inflation_contributions_graph_data_XTS)<-c("Date","Energy","Food","NEIG","Rent","Core Services")
...
* As inflation becomes broad based in nature a greater proportion of the inflation basket records higher rates of inflation. 
<br>
<br>
...
SERVICES_GOODS_XTS_INDEX_GROWTH<-as.xts(growth_index)  %>%.["2021/"]
...
DFFF<-melt(Graph_Data_Heatmap,id=c("index as xts DFF"))
...
***
* The heatmap above focuses on the top 20 series contributing most to annual inflation in the current month. 
<br>
<br>
...
FOOD_EA_XTS<-rdb("Eurostat/prc_hicp_ctrb/M.PC_PNT.CP011.EA") %>% .$value %>% as.numeric() %>% as.xts(order.by = rdb("Eurostat/prc_hicp_ctrb/M.PC_PNT.CP011.EA") %>% .$period)
...
EA_INFLATION_CONTRIBUTION<-merge(CORE_SERVICES_EA_XTS["2019/"],ENERGY_EA_XTS["2019/"],NEIG_EA_XTS["2019/"],RENT_EA_XTS["2019/"],FOOD_EA_XTS["2019/"],MISC_GOOD_SERVICES_EA_XTS["2019/"])
...
delta_EA_IRE_ONE<-data.frame(EA_INFLATION_CONTRIBUTION$CORE_SERVICES_EA_XTS-IRE_INFLATION_CONTRIBUTION$CORE_SERVICES[1:length(EA_INFLATION_CONTRIBUTION$CORE_SERVICES_EA_XTS)],
  EA_INFLATION_CONTRIBUTION$NEIG_EA_XTS-IRE_INFLATION_CONTRIBUTION$NEIG[1:length(EA_INFLATION_CONTRIBUTION$CORE_SERVICES_EA_XTS)],
  EA_INFLATION_CONTRIBUTION$RENT_EA_XTS-IRE_INFLATION_CONTRIBUTION$Rent[1:length(EA_INFLATION_CONTRIBUTION$CORE_SERVICES_EA_XTS)],
  EA_INFLATION_CONTRIBUTION$FOOD_EA_XTS-IRE_INFLATION_CONTRIBUTION$FOOD[1:length(EA_INFLATION_CONTRIBUTION$CORE_SERVICES_EA_XTS)],
  EA_INFLATION_CONTRIBUTION$ENERGY_EA_XTS-IRE_INFLATION_CONTRIBUTION$ENERGY[1:length(EA_INFLATION_CONTRIBUTION$CORE_SERVICES_EA_XTS)], index(EA_INFLATION_CONTRIBUTION$FOOD_EA_XTS..2019...["2019/"])
) 


delta_EA_IRE<-delta_EA_IRE_ONE %>% .[37:nrow(delta_EA_IRE_ONE),] %>% melt(id=c("index.EA_INFLATION_CONTRIBUTION.FOOD_EA_XTS..2019.....2019....")) %>% na.omit() %>%  mutate(variable = recode(.$variable,  "RENT_EA_XTS..2019..." = "Rent","NEIG_EA_XTS..2019..." ="NEIG","FOOD_EA_XTS..2019..." ="Food","CORE_SERVICES_EA_XTS..2019..." ="Core Services","ENERGY_EA_XTS..2019..." ="Energy"))
...
DELTA_EA_IRE_CON_plot<-ggplot(data=delta_EA_IRE, aes(y=value*-1, x=index.EA_INFLATION_CONTRIBUTION.FOOD_EA_XTS..2019.....2019...., fill=variable)) + 
  ...
  scale_y_continuous(labels=function(x) paste0(x,"%"))+theme_bw()+theme(panel.border = element_blank(),axis.line =element_line(colour = "black"))+theme(legend.position=c(0.9,0.2),plot.title = element_text(hjust = 0.5),legend.background=element_blank())
...
```{r services index, echo=FALSE, warning=FALSE}

names(GOOD_SERVICES_INDEX)<-c("Bread & Cereals","Meat","Fish","Milk, Cheese,eggs","Oil & Fats","Fruit","Vegetables","Sugar,Jam, Honey, Chocolate","Food Products","Coffee, tea, Cocoa","Mineral Water, Soft Drinks, Vegetable Juices","Spirits","Wine","Beer","Tobacco","Garments","Other Clothing","Footwear","Material for the maintenance of dwellings","Electricity","Gas","Liquid Fuel","Solid Fuels","Furniture","Carpets","Household textiles","Major Household Appliances","Glassware,tableware and Utensils","House & Garden Tools","Non-durable househld goods","Pharma Products","Other medical products", "Motor Cars","Motor Cycles, Bicycles", "Spare parts personal transport", "Fuels & Lubricants for personal transport", "Recording Equipment",  "Information processing equipment", "Recording Media", "Musical Instruments", "Games, Toys, hobbies", "Sports & outdoor Equipment","Gardens, plants and flowers", "Pets Products", "Books","Newspapers", "Misc. Print","Electrical Appliances for personal care", "Jewellery, clocks, watches", "Other Personal effects","Actual Rent", "Repair of Dwelling","Repair of Household Appliances", "Domestic Services and Household Services","Insurance for Dwellings","Cleaning & Repair Clothing","Repair of audio-visual","Recreational & Sporting Services","Cultural Services", "Restaurant, Cafes etc.","Canteens","Hairdressing Salons","Repair Personal Transport","Other services for Personal Transport","Passenger transport by railway","Passenger transport by road","Passenger transport by air","Passenger transport by sea","Combined Passenger transport","Other purchased transport services","Package Holidays","Accomdation Services","Medical Services", "Dental Services","Hospital Services","Education","Social Protection","Healthcare Insurance","Transport Insurance","Financial Services","Other Services","Postal Services","Telephone equipment and services","Refuse Collection", "Other Services for Dwellings") 

names(GOOD_SERVICES_INDEX)<-GOOD_SERVICES_INDEX %>% names() %>% gsub(
                        pattern = "\\,",
                        replacement = ".") %>%  gsub(
                        pattern = " .",
                        replacement = ".")    %>% str_squish()
...
SERVICES_MAIN_COMPONENTS<-last(SERVICES_CONTRIBUTION)[,order(as.numeric(as.character(last(SERVICES_CONTRIBUTION))),decreasing = TRUE)][,1:4]

SERVICES_OTHER_COMPONENTS<-rowSums(SERVICES_CONTRIBUTION)-rowSums(SERVICES_CONTRIBUTION[,names(SERVICES_MAIN_COMPONENTS)])

Services_graph_data<-data.frame(SERVICES_CONTRIBUTION[,names(SERVICES_MAIN_COMPONENTS)][30:nrow(SERVICES_CONTRIBUTION[,names(SERVICES_MAIN_COMPONENTS)]),],SERVICES_OTHER_COMPONENTS[30:nrow(SERVICES_CONTRIBUTION[,names(SERVICES_MAIN_COMPONENTS)])],index(CHAIN_CORE_SERVICES_CONTRIBUTION["2021-06-01/"]))

colnames(Services_graph_data)<-c(names(SERVICES_MAIN_COMPONENTS),"Other","Date")
Services_graph_data<-melt(Services_graph_data,id=c("Date"))

NAMEING_SERVICE_CON<-as.data.frame(paste(unique(Services_graph_data$variable)[1:5]))


INFLATION_SERVICES_CON_plot<-ggplot(data=Services_graph_data, aes(y=value, x=Date, fill=variable)) + 
  geom_bar(position="stack", stat="identity")+theme(legend.position='bottom',element_text(size=100))+
  labs(x="",
       title="Contribution to Services Inflation",
       caption="Source: CSO",
       y="contribution to annual growth (%)")+
  scale_y_continuous(labels=function(x) paste0(x,"%"))+theme_bw()+theme(panel.border = element_blank(),axis.line =element_line(colour = "black"))
...
LINE_DATA_SERVICES<-data.frame(index(CHAIN_CORE_SERVICES_CONTRIBUTION["2021-06-01/"]),rowSums(SERVICES_CONTRIBUTION)[30:nrow(SERVICES_CONTRIBUTION[,names(SERVICES_MAIN_COMPONENTS)])])
colnames(LINE_DATA_SERVICES)<-c("Date","Services")

LINE_DATA_SERVICES<-melt(LINE_DATA_SERVICES, id=c("Date"))

INFLATION_SERVICES_CON_plot_WITH_LINE<-INFLATION_SERVICES_CON_plot+geom_line(data=LINE_DATA_SERVICES,aes(x=Date, y=value),size = 1.2)+
  scale_fill_manual(name = "",values=c("#01A685", 
                             "#A3915E",
                             "#0190D4",
                             "#dbac00",
                             "#afb6bd",
                             "#4473c4"
                             ),    limits = c(unique(Services_graph_data$variable))
  
)+theme(legend.position=c(0.2,0.9),plot.title = element_text(hjust = 0.5),legend.background=element_blank())

GROWTH_COMPONENTS_XTS<-as.xts(GROWTH_COMPONENTS)

INFLATION_SERVICES_CON_plot_WITH_LINE

SERVICES_TEXT_1<-round(last(rowSums(SERVICES_CONTRIBUTION)*1000),1) %>% paste0("% on an annual basis")
SERVICES_TEXT_2_NAME<-names(SERVICES_MAIN_COMPONENTS[,1]) %>% gsub(
                        pattern = "\\,",
                        replacement = " ") %>%  gsub(
                        pattern = "\\.",
                        replacement = " ")    %>% str_squish()
...
* The graph above illustrates the contribution of the various components to services inflation. 
<br>
<br>

* In `r CURRENT` Services inflation increased by `r SERVICES_TEXT_1`. 
<br>
<br>

* The growth in service prices was driven by `r SERVICES_TEXT_2_NAME` which `r conditional(as.numeric(GROWTH_COMPONENTS_XTS[nrow(GROWTH_COMPONENTS_XTS),SERVICES_TEXT_2_NAME]))`  
<br>
<br>
