...
```{r Text_calculations, echo=FALSE, warning=FALSE}
...
Latest_inflation_low_DATE <- last(Energy_inflation_chart$Date) %>% format("%B %Y")
...
Overall, energy contributed `r Energy_contribution` to overall inflation in `r Energy_contribution_DATE`.
