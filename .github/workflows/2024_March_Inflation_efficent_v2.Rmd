dataset_names <- list('Annual Export -Country'=Contribution_annual_growth_DF,' Annual Export -Product' =Contribution_Prod_CON_DF,'Annual Import -Country'=Contribution_annual__IMPORT_growth_DF)="color:#A3915E"> <center> <font size="6">  **Inflation Chartpack**  </font> </center> </span>
output: 
...
delta_EA_IRE_ONE<-data.frame(EA_INFLATION_CONTRIBUTION$CORE_SERVICES_EA_XTS-IRE_INFLATION_CONTRIBUTION$CORE_SERVICES,
  ...
  EA_INFLATION_CONTRIBUTION$ENERGY_EA_XTS-IRE_INFLATION_CONTRIBUTION$ENERGY, index(EA_INFLATION_CONTRIBUTION$FOOD_EA_XTS..2019...["2019/"])
) 
