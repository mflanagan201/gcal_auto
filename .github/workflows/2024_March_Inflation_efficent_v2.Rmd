...
IRE_EA_DIFF<-data.frame(index(EA_INFLATION["2022/"]), as.numeric(as.xts(LINE_DATA)[paste0("2022/",index(last(EA_INFLATION)),"")][,2])-as.numeric(EA_INFLATION["2022/"])) 
...
```{r services index, warning=FALSE, include=FALSE}
