...
#for(i in 1:nrow(OECD_Schedule_table_2)){
# if(grepl("OECD Interim Economic Outlook", OECD_Schedule_table_2[i,1], ignore.case = TRUE)){
...
event_all =subset(event_all, !(SUMMARY %like any% c("%Monthly Mortality and Average Temperatures in Ireland%","%Educational Attainment%","%Sustainability of Personal ICT Devices%","%Press Statement: Transport Hub%","%Press Statement Women and Men in Ireland Hub%","%Household Digital Consumer Behaviour%",
