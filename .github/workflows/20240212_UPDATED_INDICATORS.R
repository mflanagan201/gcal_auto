...
read.xlsx("C:/Users/flanagam/Documents/HOUSECOMMENCEMNTS.xlsx")
...
if(na.omit(Current_Comm[ncol(Current_Comm)])[1,1] == na.omit(NEW_DATA[ncol(NEW_DATA)])[1,1]){
  UPDATED_INDEX<-paste0("* ",print("Housing Commencements, Availble: "),HREF)
...
UPDATED_EMAIL<-emayili::envelope(
  ...
  emayili::render(' <span class="text-center" style="color:#A3915E"> <left> <font size="4"> *Hi, It seems like the following indicator has just been updated!* </font> </left> </span>
