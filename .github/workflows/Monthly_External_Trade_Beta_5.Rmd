...
for (i in 1:length(index(Australia_exports_xts["2015/"]))) {
  Australia_sum_export[i] <- sum(as.numeric(Australia_exports_xts[i, 2:ncol(Australia_exports_xts)]), na.rm = TRUE)
}
...
for (i in 1:length(index(Belgium_exports_xts["2015/"]))) {
  Belgium_sum_export[i] <- sum(as.numeric(Belgium_exports_xts[i, 2:ncol(Belgium_exports_xts)]), na.rm = TRUE)
}
...
for (i in 1:length(index(Bulgaria_exports_xts["2015/"]))) {
  Bulgaria_sum_export[i] <- sum(as.numeric(Bulgaria_exports_xts[i, 2:ncol(Bulgaria_exports_xts)]), na.rm = TRUE)
}
...
for (i in 1:length(index(Brazil_exports_xts["2015/"]))) {
  Brazil_sum_export[i] <- sum(as.numeric(Brazil_exports_xts[i, 2:ncol(Brazil_exports_xts)]), na.rm = TRUE)
}
...
for (i in 1:length(index(Canada_exports_xts["2015/"]))) {
  Canada_sum_export[i] <- sum(as.numeric(Canada_exports_xts[i, 2:ncol(Canada_exports_xts)]), na.rm = TRUE)
}
...
for (i in 1:length(index(Switzerland_exports_xts["2015/"]))) {
  Switzerland_sum_export[i] <- sum(as.numeric(Switzerland_exports_xts[i, 2:ncol(Switzerland_exports_xts)]), na.rm = TRUE)
}
...
for (i in 1:length(index(China_exports_xts["2015/"]))) {
  China_sum_export[i] <- sum(as.numeric(China_exports_xts[i, 2:ncol(China_exports_xts)]), na.rm = TRUE)
}
...
for (i in 1:length(index(Japan_exports_xts["2015/"]))) {
  Japan_sum_export[i] <- sum(as.numeric(Japan_exports_xts[i, 2:ncol(Japan_exports_xts)]), na.rm = TRUE)
}
...
for (i in 1:length(index(Korea_exports_xts["2015/"]))) {
  Korea_sum_export[i]<-sum(as.numeric(Korea_exports_xts[i,2:ncol(Korea_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(Lithuania_exports_xts["2015/"]))) {
  Lithuania_sum_export[i]<-sum(as.numeric(Lithuania_exports_xts[i,2:ncol(Lithuania_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(Luxembourg_exports_xts["2015/"]))) {
  Luxembourg_sum_export[i]<-sum(as.numeric(Luxembourg_exports_xts[i,2:ncol(Luxembourg_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(Latvia_exports_xts["2015/"]))) {
  Latvia_sum_export[i]<-sum(as.numeric(Latvia_exports_xts[i,2:ncol(Latvia_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(Malta_exports_xts["2015/"]))) {
  Malta_sum_export[i]<-sum(as.numeric(Malta_exports_xts[i,2:ncol(Malta_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(Mexico_exports_xts["2015/"]))) {
  Mexico_sum_export[i]<-sum(as.numeric(Mexico_exports_xts[i,2:ncol(Mexico_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(Malaysia_exports_xts["2015/"]))) {
  Malaysia_sum_export[i]<-sum(as.numeric(Malaysia_exports_xts[i,2:ncol(Malaysia_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(Netherlands_exports_xts["2015/"]))) {
  Netherlands_sum_export[i]<-sum(as.numeric(Netherlands_exports_xts[i,2:ncol(Netherlands_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(Norway_exports_xts["2015/"]))) {
  Norway_sum_export[i]<-sum(as.numeric(Norway_exports_xts[i,2:ncol(Norway_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(Poland_exports_xts["2015/"]))) {
  Poland_sum_export[i]<-sum(as.numeric(Poland_exports_xts[i,2:ncol(Poland_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(Portugal_exports_xts["2015/"]))) {
  Portugal_sum_export[i]<-sum(as.numeric(Portugal_exports_xts[i,2:ncol(Portugal_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(Romania_exports_xts["2015/"]))) {
  Romania_sum_export[i]<-sum(as.numeric(Romania_exports_xts[i,2:ncol(Romania_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(Russia_exports_xts["2015/"]))) {
  Russia_sum_export[i]<-sum(as.numeric(Russia_exports_xts[i,2:ncol(Russia_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(Saudi_exports_xts["2015/"]))) {
  Saudi_sum_export[i]<-sum(as.numeric(Saudi_exports_xts[i,2:ncol(Saudi_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(Sweden_exports_xts["2015/"]))) {
  Sweden_sum_export[i]<-sum(as.numeric(Sweden_exports_xts[i,2:ncol(Sweden_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(Singapore_exports_xts["2015/"]))) {
  Singapore_sum_export[i]<-sum(as.numeric(Singapore_exports_xts[i,2:ncol(Singapore_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(Slovenia_exports_xts["2015/"]))) {
  Slovenia_sum_export[i]<-sum(as.numeric(Slovenia_exports_xts[i,2:ncol(Slovenia_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(Slovakia_exports_xts["2015/"]))) {
  Slovakia_sum_export[i]<-sum(as.numeric(Slovakia_exports_xts[i,2:ncol(Slovakia_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(Thailand_exports_xts["2015/"]))) {
  Thailand_sum_export[i]<-sum(as.numeric(Thailand_exports_xts[i,2:ncol(Thailand_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(Turkey_exports_xts["2015/"]))) {
  Turkey_sum_export[i]<-sum(as.numeric(Turkey_exports_xts[i,2:ncol(Turkey_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(Taiwan_exports_xts["2015/"]))) {
  Taiwan_sum_export[i]<-sum(as.numeric(Taiwan_exports_xts[i,2:ncol(Taiwan_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(USA_exports_xts["2015/"]))) {
  USA_sum_export[i]<-sum(as.numeric(USA_exports_xts[i,2:ncol(USA_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(GB_exports_xts["2015/"]))) {
  GB_sum_export[i]<-sum(as.numeric(GB_exports_xts[i,2:ncol(GB_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(NI_exports_xts["2015/"]))) {
  NI_sum_export[i]<-sum(as.numeric(NI_exports_xts[i,2:ncol(NI_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(SA_exports_xts["2015/"]))) {
  SA_sum_export[i]<-sum(as.numeric(SA_exports_xts[i,2:ncol(SA_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(OTHER_EU_exports_xts["2015/"]))) {
  OTHER_EU_sum_export[i]<-sum(as.numeric(OTHER_EU_exports_xts[i,2:ncol(OTHER_EU_exports_xts)]),na.rm = TRUE)
}
...
for (i in 1:length(index(OTHER_exports_xts["2015/"]))) {
  OTHER_sum_export[i]<-sum(as.numeric(OTHER_exports_xts[i,2:ncol(OTHER_exports_xts)]),na.rm = TRUE)
}
...
summary_table<-data.frame((merge(monthly_growth_exports_vol["2024-01-01/"],monthly_growth_exports_val["2024-01-01/"],monthly_growth_imports_val["2024-01-01/"],annual_growth_exports_vol["2024-01-01/"],annual_growth_exports_val["2024-01-01/"],annual_growth_imports_val["2024-01-01/"])))
...
kabble_format_table_fix_email<-kabble_format_table_short %>% kableExtra::column_spec(ncol(summary_table)) %>%
  ...
  column_spec(ncol(summary_table)+1,include_thead = FALSE, color = ifelse(is.na(summary_table[,ncol(summary_table)]<=0), "red",DOF_colours[1]))  
...
MEDIUM_TERM<-merge(EXPORT_YTD,THREE_MONTH_XTS,SIX_MONTH_XTS,TWELEVE_MONTH_XTS) %>% .["2024-01-01/"] 
MEDIUM_TERM_T<-MEDIUM_TERM %>% t()
rownames(MEDIUM_TERM_T)<-c("Year to Date (y-o-y)","Three month (y-o-y)", "Six month (y-o-y)", "Tweleve month (y-o-y)")
...
kabble_format_table_MEDIUM_TERM<-kabble_format_table_MEDIUM_TERM %>% kableExtra::column_spec(ncol(MEDIUM_TERM_T)) %>%
  kableExtra::row_spec(nrow(MEDIUM_TERM_T))  



TEXT_THREE_MONTH<-conditional(last(THREE_MONTH_XTS))
...
Medium_TERM_DATA<-merge(EXPORT_YTD,THREE_MONTH_XTS,SIX_MONTH_XTS,TWELEVE_MONTH_XTS)
...
SUMMARY_EXPORT_DATA_DOWNLOAD$`Short Term`<-c("Date","Export Volume (M-o-M)","Export Value (M-o-M)","Import Value (M-o-M)","Export Volume (Y-o-Y)","Export Value (Y-o-Y)","Import Value (Y-o-Y)")

SUMMARY_EXPORT_DATA_DOWNLOAD$`Medium Term`<-c("Date","Year to Date","Three Month Export Growth (Y-o-Y)","Six Month Export Growth (Y-o-Y)","Tweleve Month Export Growth (Y-o-Y)")
