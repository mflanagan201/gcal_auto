...
kabble_format_table_fix_email<-kabble_format_table_short %>% kableExtra::column_spec(ncol(summary_table)) %>%
  ...
  column_spec(ncol(summary_table)+1,include_thead = FALSE, color = ifelse(is.na(summary_table[,ncol(summary_table)]<=0), "black","red")) %>% as_image()
...
-   Compared to Pre-Covid levels, the seasonally adjusted value and volume of exports have `r Pre_Covid_export_text` and `r Pre_Covid_export_text_vol` respectively. <br> <br>
