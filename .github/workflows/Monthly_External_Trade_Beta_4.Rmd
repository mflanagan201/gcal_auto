...
delta_Budget_2022<-(YTD_2022_annual-1.4)
...
<br>
<br>
-  As part of Budget, the Department forecast nominal goods export growth of 1.4% in 2023. Year to date, exports have `r YTD_2022_annual_text` in `r current_date`. As a result exports are currently running `r export_nominal_budget`.  
<br>
<br>
...
Imports_graph<-Imports_graph+ theme(legend.position=c(0.5, 0.2))
