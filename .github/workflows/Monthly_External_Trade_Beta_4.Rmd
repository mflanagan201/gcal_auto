...
conditional_alt4 <- function(x){
  if (x < 0) {
    print(paste(round(x,1), "percentage points below what was forecast at the time of the SPU"))
  } else if (x >0){
    print(paste(round(x,1), "percentage points above what was forecast at the time of the SPU"))
  } else {
...
Date_vol<-seq(as.Date("1969-11-01"), by="month",length.out=NROW(Ire_Exports_SA_vol)) 
...
Ireland_Exports_SA_vol_xts<-na.locf(as.xts(Ire_Exports_SA_vol, order.by = Date_vol),na.rm=TRUE)
...
Ireland_Exports_vol_xts<-na.locf(as.xts(Ire_Exports_vol, order.by = Date_vol),na.rm=TRUE)
...
#Volume data  Not seasonally adjusted for annual analysis 
Ireland_Imports_vol_xts<-na.locf(as.xts(Ire_Imports_vol, order.by = Date_vol),na.rm=TRUE)
...
YTD_2022_annual_IMPORT<- 100*(sum(Ireland_Imports_val_NASA_xts["2023"])-sum(Ireland_Imports_val_NASA_xts["2022"][1:length(Ireland_Imports_val_NASA_xts["2023"])]))/sum(Ireland_Imports_val_NASA_xts["2022"][1:length(Ireland_Imports_val_NASA_xts["2023"])])
...
#Austria
Austria_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Austria") %>% select(-Country))
colnames(Austria_exports) <-Austria_exports[1,]
Austria_exports<-Austria_exports[-c(1),]
Austria_exports<-Austria_exports[,-c(10)]
...
for (i in 1:length(index(Austria_exports_xts["2015/"]))) {
  Austria_sum_export[i]<-sum(as.numeric(Austria_exports_xts[i]),na.rm = TRUE)
}
...
#Australia
Australia_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Australia") %>% select(-Country))
colnames(Australia_exports) <-Australia_exports[1,]
Australia_exports<-Australia_exports[-c(1),]
Australia_exports<-Australia_exports[,-c(10)]
...
for (i in 1:length(index(Australia_exports_xts["2015/"]))) {
  Australia_sum_export[i]<-sum(as.numeric(Australia_exports_xts[i]),na.rm = TRUE)
}
...
#Belgium
Belgium_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Belgium") %>% select(-Country))
colnames(Belgium_exports) <-Belgium_exports[1,]
Belgium_exports<-Belgium_exports[-c(1),]
Belgium_exports<-Belgium_exports[,-c(10)]
...
for (i in 1:length(index(Belgium_exports_xts["2015/"]))) {
  Belgium_sum_export[i]<-sum(as.numeric(Belgium_exports_xts[i]),na.rm = TRUE)
}
...
#Bulgaria
Bulgaria_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Bulgaria") %>% select(-Country))
colnames(Bulgaria_exports) <-Bulgaria_exports[1,]
Bulgaria_exports<-Bulgaria_exports[-c(1),]
Bulgaria_exports<-Bulgaria_exports[,-c(10)]
...
for (i in 1:length(index(Bulgaria_exports_xts["2015/"]))) {
  Bulgaria_sum_export[i]<-sum(as.numeric(Bulgaria_exports_xts[i]),na.rm = TRUE)
}
...
#Brazil 
Brazil_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Brazil") %>% select(-Country))
colnames(Brazil_exports) <-Brazil_exports[1,]
Brazil_exports<-Brazil_exports[-c(1),]
Brazil_exports<-Brazil_exports[,-c(10)]
...
for (i in 1:length(index(Brazil_exports_xts["2015/"]))) {
  Brazil_sum_export[i]<-sum(as.numeric(Brazil_exports_xts[i]),na.rm = TRUE)
}
...
#Canada 
Canada_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Canada") %>% select(-Country))
colnames(Canada_exports) <-Canada_exports[1,]
Canada_exports<-Canada_exports[-c(1),]
Canada_exports<-Canada_exports[,-c(10)]
...
for (i in 1:length(index(Canada_exports_xts["2015/"]))) {
  Canada_sum_export[i]<-sum(as.numeric(Canada_exports_xts[i]),na.rm = TRUE)
}
...
#Switzerland 
Switzerland_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Switzerland") %>% select(-Country))
colnames(Switzerland_exports) <-Switzerland_exports[1,]
Switzerland_exports<-Switzerland_exports[-c(1),]
Switzerland_exports<-Switzerland_exports[,-c(10)]
...
for (i in 1:length(index(Switzerland_exports_xts["2015/"]))) {
  Switzerland_sum_export[i]<-sum(as.numeric(Switzerland_exports_xts[i]),na.rm = TRUE)
}
...
#China 
China_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="China") %>% select(-Country))
colnames(China_exports) <-China_exports[1,]
China_exports<-China_exports[-c(1),]
China_exports<-China_exports[,-c(10)]
...
for (i in 1:length(index(China_exports_xts["2015/"]))) {
  China_sum_export[i]<-sum(as.numeric(China_exports_xts[i]),na.rm = TRUE)
}
...
#Cyprus 
Cyprus_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Cyprus") %>% select(-Country))
colnames(Cyprus_exports) <-Cyprus_exports[1,]
Cyprus_exports<-Cyprus_exports[-c(1),]
Cyprus_exports<-Cyprus_exports[,-c(10)]
...
for (i in 1:length(index(Cyprus_exports_xts["2015/"]))) {
  Cyprus_sum_export[i]<-sum(as.numeric(Cyprus_exports_xts[i]),na.rm = TRUE)
}
...
#Czech Republic
Czech_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Czech Republic") %>% select(-Country))
colnames(Czech_exports) <-Czech_exports[1,]
Czech_exports<-Czech_exports[-c(1),]

Czech_exports<-Czech_exports[,-c(10)]
...
for (i in 1:length(index(Czech_exports_xts["2015/"]))) {
  Czech_sum_export[i]<-sum(as.numeric(Czech_exports_xts[i]),na.rm = TRUE)
}
...
#Germany
Germany_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Germany") %>% select(-Country))
colnames(Germany_exports) <-Germany_exports[1,]
Germany_exports<-Germany_exports[-c(1),]

Germany_exports<-Germany_exports[,-c(10)]
...
for (i in 1:length(index(Germany_exports_xts["2015/"]))) {
  Germany_sum_export[i]<-sum(as.numeric(Germany_exports_xts[i]),na.rm = TRUE)
}
...
#Denmark 
Denmark_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Denmark") %>% select(-Country))
colnames(Denmark_exports) <-Denmark_exports[1,]
Denmark_exports<-Denmark_exports[-c(1),]
Denmark_exports<-Denmark_exports[,-c(10)]
...
for (i in 1:length(index(Denmark_exports_xts["2015/"]))) {
  Denmark_sum_export[i]<-sum(as.numeric(Denmark_exports_xts[i]),na.rm = TRUE)
}
...
#Estonia 
Estonia_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Estonia") %>% select(-Country))
colnames(Estonia_exports) <-Estonia_exports[1,]
Estonia_exports<-Estonia_exports[-c(1),]
Estonia_exports<-Estonia_exports[,-c(10)]
...
for (i in 1:length(index(Estonia_exports_xts["2015/"]))) {
  Estonia_sum_export[i]<-sum(as.numeric(Estonia_exports_xts[i]),na.rm = TRUE)
}
...
#Spain 
Spain_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Spain") %>% select(-Country))
colnames(Spain_exports) <-Spain_exports[1,]
Spain_exports<-Spain_exports[-c(1),]
Spain_exports<-Spain_exports[,-c(10)]
...
for (i in 1:length(index(Spain_exports_xts["2015/"]))) {
  Spain_sum_export[i]<-sum(as.numeric(Spain_exports_xts[i]),na.rm = TRUE)
}
...
#Finland 
Finland_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Finland") %>% select(-Country))
colnames(Finland_exports) <-Finland_exports[1,]
Finland_exports<-Finland_exports[-c(1),]
Finland_exports<-Finland_exports[,-c(10)]
...
for (i in 1:length(index(Finland_exports_xts["2015/"]))) {
  Finland_sum_export[i]<-sum(as.numeric(Finland_exports_xts[i]),na.rm = TRUE)
}
...
#France
France_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="France") %>% select(-Country))
colnames(France_exports) <-France_exports[1,]
France_exports<-France_exports[-c(1),]
France_exports<-France_exports[,-c(10)]
...
for (i in 1:length(index(France_exports_xts["2015/"]))) {
  France_sum_export[i]<-sum(as.numeric(France_exports_xts[i]),na.rm = TRUE)
}
...
#Greece
Greece_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Greece") %>% select(-Country))
colnames(Greece_exports) <-Greece_exports[1,]
Greece_exports<-Greece_exports[-c(1),]
Greece_exports<-Greece_exports[,-c(10)]
...
for (i in 1:length(index(Greece_exports_xts["2015/"]))) {
  Greece_sum_export[i]<-sum(as.numeric(Greece_exports_xts[i]),na.rm = TRUE)
}
...
##Croatia
Croatia_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Croatia") %>% select(-Country))
colnames(Croatia_exports) <-Croatia_exports[1,]
Croatia_exports<-Croatia_exports[-c(1),]
Croatia_exports<-Croatia_exports[,-c(10)]
...
for (i in 1:length(index(Croatia_exports_xts["2015/"]))) {
  Croatia_sum_export[i]<-sum(as.numeric(Croatia_exports_xts[i]),na.rm = TRUE)
}
...
#Hungary
Hungary_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Hungary") %>% select(-Country))
colnames(Hungary_exports) <-Hungary_exports[1,]
Hungary_exports<-Hungary_exports[-c(1),]
Hungary_exports<-Hungary_exports[,-c(10)]
...
for (i in 1:length(index(Hungary_exports_xts["2015/"]))) {
  Hungary_sum_export[i]<-sum(as.numeric(Hungary_exports_xts[i]),na.rm = TRUE)
}
...
#India
India_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="India") %>% select(-Country))
colnames(India_exports) <-India_exports[1,]
India_exports<-India_exports[-c(1),]
India_exports<-India_exports[,-c(10)]
...
for (i in 1:length(index(India_exports_xts["2015/"]))) {
  India_sum_export[i]<-sum(as.numeric(India_exports_xts[i]),na.rm = TRUE)
}
...
#Italy
Italy_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Italy") %>% select(-Country))
colnames(Italy_exports) <-Italy_exports[1,]
Italy_exports<-Italy_exports[-c(1),]
Italy_exports<-Italy_exports[,-c(10)]
...
for (i in 1:length(index(Italy_exports_xts["2015/"]))) {
  Italy_sum_export[i]<-sum(as.numeric(Italy_exports_xts[i]),na.rm = TRUE)
}
...
Japan_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Japan") %>% select(-Country))
colnames(Japan_exports) <-Japan_exports[1,]
Japan_exports<-Japan_exports[-c(1),]
Japan_exports<-Japan_exports[,-c(10)]
...
for (i in 1:length(index(Japan_exports_xts["2015/"]))) {
  Japan_sum_export[i]<-sum(as.numeric(Japan_exports_xts[i]),na.rm = TRUE)
}
...
#South Korea
Korea_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="South Korea") %>% select(-Country))
colnames(Korea_exports) <-Korea_exports[1,]
Korea_exports<-Korea_exports[-c(1),]
Korea_exports<-Korea_exports[,-c(10)]
...
for (i in 1:length(index(Korea_exports_xts["2015/"]))) {
  Korea_sum_export[i]<-sum(as.numeric(Korea_exports_xts[i]),na.rm = TRUE)
}
...
#Lithuania
Lithuania_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Lithuania") %>% select(-Country))
colnames(Lithuania_exports) <-Lithuania_exports[1,]
Lithuania_exports<-Lithuania_exports[-c(1),]
Lithuania_exports<-Lithuania_exports[,-c(10)]
...
for (i in 1:length(index(Lithuania_exports_xts["2015/"]))) {
  Lithuania_sum_export[i]<-sum(as.numeric(Lithuania_exports_xts[i]),na.rm = TRUE)
}
...
#Luxembourg 
Luxembourg_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Luxembourg") %>% select(-Country))
colnames(Luxembourg_exports) <-Luxembourg_exports[1,]
Luxembourg_exports<-Luxembourg_exports[-c(1),]
Luxembourg_exports<-Luxembourg_exports[,-c(10)]
...
for (i in 1:length(index(Luxembourg_exports_xts["2015/"]))) {
  Luxembourg_sum_export[i]<-sum(as.numeric(Luxembourg_exports_xts[i]),na.rm = TRUE)
}
...
#Latvia 
Latvia_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Latvia") %>% select(-Country))
colnames(Latvia_exports) <-Latvia_exports[1,]
Latvia_exports<-Latvia_exports[-c(1),]
Latvia_exports<-Latvia_exports[,-c(10)]
...
for (i in 1:length(index(Latvia_exports_xts["2015/"]))) {
  Latvia_sum_export[i]<-sum(as.numeric(Latvia_exports_xts[i]),na.rm = TRUE)
}
...
#Malta 
Malta_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Malta") %>% select(-Country))
colnames(Malta_exports) <-Malta_exports[1,]
Malta_exports<-Malta_exports[-c(1),]
Malta_exports<-Malta_exports[,-c(10)]
...
for (i in 1:length(index(Malta_exports_xts["2015/"]))) {
  Malta_sum_export[i]<-sum(as.numeric(Malta_exports_xts[i]),na.rm = TRUE)
}
...
#Mexico 
Mexico_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Mexico") %>% select(-Country))
colnames(Mexico_exports) <-Mexico_exports[1,]
Mexico_exports<-Mexico_exports[-c(1),]
Mexico_exports<-Mexico_exports[,-c(10)]
...
for (i in 1:length(index(Mexico_exports_xts["2015/"]))) {
  Mexico_sum_export[i]<-sum(as.numeric(Mexico_exports_xts[i]),na.rm = TRUE)
}
...
#Malaysia 
Malaysia_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Malaysia") %>% select(-Country))
colnames(Malaysia_exports) <-Malaysia_exports[1,]
Malaysia_exports<-Malaysia_exports[-c(1),]
Malaysia_exports<-Malaysia_exports[,-c(10)]
...
for (i in 1:length(index(Malaysia_exports_xts["2015/"]))) {
  Malaysia_sum_export[i]<-sum(as.numeric(Malaysia_exports_xts[i]),na.rm = TRUE)
}
...
#Netherlands 
Netherlands_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Netherlands") %>% select(-Country))
colnames(Netherlands_exports) <-Netherlands_exports[1,]
Netherlands_exports<-Netherlands_exports[-c(1),]
Netherlands_exports<-Netherlands_exports[,-c(10)]
...
for (i in 1:length(index(Netherlands_exports_xts["2015/"]))) {
  Netherlands_sum_export[i]<-sum(as.numeric(Netherlands_exports_xts[i]),na.rm = TRUE)
}
...
#Norway  
Norway_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Norway") %>% select(-Country))
colnames(Norway_exports) <-Norway_exports[1,]
Norway_exports<-Norway_exports[-c(1),]
Norway_exports<-Norway_exports[,-c(10)]
...
for (i in 1:length(index(Norway_exports_xts["2015/"]))) {
  Norway_sum_export[i]<-sum(as.numeric(Norway_exports_xts[i]),na.rm = TRUE)
}
...
#Poland  
Poland_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Poland") %>% select(-Country))
colnames(Poland_exports) <-Poland_exports[1,]
Poland_exports<-Poland_exports[-c(1),]
Poland_exports<-Poland_exports[,-c(10)]
...
for (i in 1:length(index(Poland_exports_xts["2015/"]))) {
  Poland_sum_export[i]<-sum(as.numeric(Poland_exports_xts[i]),na.rm = TRUE)
}
...
#Portugal  
Portugal_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Portugal") %>% select(-Country))
colnames(Portugal_exports) <-Portugal_exports[1,]
Portugal_exports<-Portugal_exports[-c(1),]
Portugal_exports<-Portugal_exports[,-c(10)]
...
for (i in 1:length(index(Portugal_exports_xts["2015/"]))) {
  Portugal_sum_export[i]<-sum(as.numeric(Portugal_exports_xts[i]),na.rm = TRUE)
}
...
#Romania  
Romania_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Romania") %>% select(-Country))
colnames(Romania_exports) <-Romania_exports[1,]
Romania_exports<-Romania_exports[-c(1),]
Romania_exports<-Romania_exports[,-c(10)]
...
for (i in 1:length(index(Romania_exports_xts["2015/"]))) {
  Romania_sum_export[i]<-sum(as.numeric(Romania_exports_xts[i]),na.rm = TRUE)
}
...
#Russia  
Russia_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Russia") %>% select(-Country))
colnames(Russia_exports) <-Russia_exports[1,]
Russia_exports<-Russia_exports[-c(1),]
Russia_exports<-Russia_exports[,-c(10)]
...
for (i in 1:length(index(Russia_exports_xts["2015/"]))) {
  Russia_sum_export[i]<-sum(as.numeric(Russia_exports_xts[i]),na.rm = TRUE)
}
...
#Saudi Arabia  
Saudi_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Saudi Arabia") %>% select(-Country))
colnames(Saudi_exports) <-Saudi_exports[1,]
Saudi_exports<-Saudi_exports[-c(1),]
Saudi_exports<-Saudi_exports[,-c(10)]
...
for (i in 1:length(index(Saudi_exports_xts["2015/"]))) {
  Saudi_sum_export[i]<-sum(as.numeric(Saudi_exports_xts[i]),na.rm = TRUE)
}
...
#Sweden  
Sweden_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Sweden") %>% select(-Country))
colnames(Sweden_exports) <-Sweden_exports[1,]
Sweden_exports<-Sweden_exports[-c(1),]
Sweden_exports<-Sweden_exports[,-c(10)]
...
for (i in 1:length(index(Sweden_exports_xts["2015/"]))) {
  Sweden_sum_export[i]<-sum(as.numeric(Sweden_exports_xts[i]),na.rm = TRUE)
}
...
#Singapore  
Singapore_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Singapore") %>% select(-Country))
colnames(Singapore_exports) <-Singapore_exports[1,]
Singapore_exports<-Singapore_exports[-c(1),]
Singapore_exports<-Singapore_exports[,-c(10)]
...
for (i in 1:length(index(Singapore_exports_xts["2015/"]))) {
  Singapore_sum_export[i]<-sum(as.numeric(Singapore_exports_xts[i]),na.rm = TRUE)
}
...
#Slovenia  
Slovenia_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Slovenia") %>% select(-Country))
colnames(Slovenia_exports) <-Slovenia_exports[1,]
Slovenia_exports<-Slovenia_exports[-c(1),]
Slovenia_exports<-Slovenia_exports[,-c(10)]
...
for (i in 1:length(index(Slovenia_exports_xts["2015/"]))) {
  Slovenia_sum_export[i]<-sum(as.numeric(Slovenia_exports_xts[i]),na.rm = TRUE)
}
...
#Slovakia  
Slovakia_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Slovakia") %>% select(-Country))
colnames(Slovakia_exports) <-Slovakia_exports[1,]
Slovakia_exports<-Slovakia_exports[-c(1),]
Slovakia_exports<-Slovakia_exports[,-c(10)]
...
for (i in 1:length(index(Slovakia_exports_xts["2015/"]))) {
  Slovakia_sum_export[i]<-sum(as.numeric(Slovakia_exports_xts[i]),na.rm = TRUE)
}
...
#Thailand  
Thailand_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Thailand") %>% select(-Country))
colnames(Thailand_exports) <-Thailand_exports[1,]
Thailand_exports<-Thailand_exports[-c(1),]
Thailand_exports<-Thailand_exports[,-c(10)]
...
for (i in 1:length(index(Thailand_exports_xts["2015/"]))) {
  Thailand_sum_export[i]<-sum(as.numeric(Thailand_exports_xts[i]),na.rm = TRUE)
}
...
#Turkey  
Turkey_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Turkey") %>% select(-Country))
colnames(Turkey_exports) <-Turkey_exports[1,]
Turkey_exports<-Turkey_exports[-c(1),]
Turkey_exports<-Turkey_exports[,-c(10)]
...
for (i in 1:length(index(Turkey_exports_xts["2015/"]))) {
  Turkey_sum_export[i]<-sum(as.numeric(Turkey_exports_xts[i]),na.rm = TRUE)
}
...
#Taiwan  
Taiwan_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Taiwan") %>% select(-Country))
colnames(Taiwan_exports) <-Taiwan_exports[1,]
Taiwan_exports<-Taiwan_exports[-c(1),]
Taiwan_exports<-Taiwan_exports[,-c(10)]
...
for (i in 1:length(index(Taiwan_exports_xts["2015/"]))) {
  Taiwan_sum_export[i]<-sum(as.numeric(Taiwan_exports_xts[i]),na.rm = TRUE)
}
...
#USA  
USA_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="USA") %>% select(-Country))
colnames(USA_exports) <-USA_exports[1,]
USA_exports<-USA_exports[-c(1),]
USA_exports<-USA_exports[,-c(10)]
...
for (i in 1:length(index(USA_exports_xts["2015/"]))) {
  USA_sum_export[i]<-sum(as.numeric(USA_exports_xts[i]),na.rm = TRUE)
}
...
#Great Britian  
GB_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Great Britain") %>% select(-Country))
colnames(GB_exports) <-GB_exports[1,]
GB_exports<-GB_exports[-c(1),]
GB_exports<-GB_exports[,-c(10)]
...
for (i in 1:length(index(GB_exports_xts["2015/"]))) {
  GB_sum_export[i]<-sum(as.numeric(GB_exports_xts[i]),na.rm = TRUE)
}
...
#Northern Ireland 
NI_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Northern Ireland") %>% select(-Country))
colnames(NI_exports) <-NI_exports[1,]
NI_exports<-NI_exports[-c(1),]
NI_exports<-NI_exports[,-c(10)]
...
for (i in 1:length(index(NI_exports_xts["2015/"]))) {
  NI_sum_export[i]<-sum(as.numeric(NI_exports_xts[i]),na.rm = TRUE)
}
...
#South Africa 
SA_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="South Africa") %>% select(-Country))
colnames(SA_exports) <-SA_exports[1,]
SA_exports<-SA_exports[-c(1),]
SA_exports<-SA_exports[,-c(10)]
...
for (i in 1:length(index(SA_exports_xts["2015/"]))) {
  SA_sum_export[i]<-sum(as.numeric(SA_exports_xts[i]),na.rm = TRUE)
}
...
OTHER_EU_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="EU country not specified") %>% select(-Country))
colnames(OTHER_EU_exports) <-OTHER_EU_exports[1,]
OTHER_EU_exports<-OTHER_EU_exports[-c(1),]
OTHER_EU_exports<-OTHER_EU_exports[,-c(10)]
...
for (i in 1:length(index(OTHER_EU_exports_xts["2015/"]))) {
  OTHER_EU_sum_export[i]<-sum(as.numeric(OTHER_EU_exports_xts[i]),na.rm = TRUE)
}
...
#OTHER 
OTHER_exports<- t(subset(Ireland_exports,Ireland_Exports["2014-12-01"]=="Other countries") %>% select(-Country))
colnames(OTHER_exports) <-OTHER_exports[1,]
OTHER_exports<-OTHER_exports[-c(1),]
OTHER_exports<-OTHER_exports[,-c(10)]
...
for (i in 1:length(index(OTHER_exports_xts["2015/"]))) {
  OTHER_sum_export[i]<-sum(as.numeric(OTHER_exports_xts[i]),na.rm = TRUE)
}
...
summary_contribution<-data.frame(merge(Contribution_annual_growth$USA["2020/"],EURO_AREA_CONTRIBUTION_ANNUAL_GROWTH$EA["2020/"],Contribution_annual_growth$China["2020/"],Contribution_annual_growth$GB["2020/"],Contribution_annual_growth$NI["2020/"],Other_contribution$OTHER["2020/"]),index(Contribution_annual_growth["2020/"]))
...
y1<-ggplot()+geom_line(data=Total_Share_3MA,aes(x=Date_3MA.Date,y=China, colour="China"),size=1)+
  ...
  labs(x="",
       ...
       y="Percentage Share (%)")+
  scale_color_manual(name = "Country", values = c("USA" = DOF_colours[1],"China" = DOF_colours[2],"Great Britian" = DOF_colours[3]))+
  ...
  geom_vline(xintercept=last(Date_3MA$Date),linetype=2,color="black")+theme_bw()+theme(panel.border = element_blank(),axis.line =element_line(colour = "black"))+
  geom_rect((aes(xmin=(Date_3MA$Date[62]), xmax=last(Date_3MA$Date), ymin=-Inf, ymax=Inf)),fill="grey",alpha = 0.1)
...
y3<-y3+ theme(legend.position="none")
...
#Year to Date calculation
YTD_2022_annual<- 100*(sum(Total_Export_Country$TOTAL["2023"])-sum(Total_Export_Country$TOTAL["2022"][1:length(Total_Export_Country$TOTAL["2023"])]))/sum(Total_Export_Country$TOTAL["2022"][1:length(Total_Export_Country$TOTAL["2023"])])
YTD_2022_annual_text<-conditional(YTD_2022_annual)

delta_Budget_2022<-(YTD_2022_annual-11)
...
summary_table<-data.frame((merge(monthly_growth_exports_vol["2022-12-01/"],monthly_growth_exports_val["2022-12-01/"],monthly_growth_imports_val["2022-12-01/"],annual_growth_exports_vol["2022-12-01/"],annual_growth_exports_val["2022-12-01/"],annual_growth_imports_val["2022-12-01/"])))
...
format_table1<-formattable(x=(summary_table),list(area(col=ncol(summary_table)) ~  formatter("span", style = ~ style(color = ifelse(summary_table[ncol(summary_table)]< summary_table[ncol(summary_table)-1], "red",ifelse(summary_table[ncol(summary_table)] >= summary_table[ncol(summary_table)-1],"green","grey"))),
 ~ icontext(ifelse(summary_table[ncol(summary_table)] =="", "arrow-none",ifelse(summary_table[ncol(summary_table)] <summary_table[ncol(summary_table)-1],"arrow-down",ifelse(summary_table[ncol(summary_table)] > summary_table[ncol(summary_table)-1],"arrow-up",""))),pull(summary_table)))))
...
webshot(html_print(as.htmlwidget(format_table1)),zoom = 3)
...
-  According to the latest data, the value of export growth in `r current_date` was `r Monthly_growth_exports_val_text` than the previous month. In `r current_date`  imports were also `r Monthly_growth_imports_val_text` the previous month.
<br>
<br>
-  On an annual basis, the value of goods exports `r annual_growth_exports_val_text` in `r current_date`.Over the same period, the value of imports `r annual_growth_imports_val_text`. 
<br>
<br>
-  On a volume basis, goods exports `r Vol_monthly_text` in `r current_date_vol` and `r Vol_annual` on an annual basis. 
<br>
<br>
-  Compared to Pre-Covid levels, the seasonally adjusted value and  volume of exports have `r Pre_Covid_export_text` and `r Pre_Covid_export_text_vol` respectively. 
<br>
<br>
-  As part of SPU 2023, the Department forecast nominal goods export growth of 11% in 2023. Year to date, exports have `r YTD_2022_annual_text` in `r current_date`. As a result exports are currently running `r export_nominal_budget`.  
<br>
<br>
...
***
 ...
 <span class="text-center" style="color:#A3915E"> <center> <font size="4">   **Goods Exports - Detailed Breakdown** </font>  </center> </span>
 
***
```{r country plots, echo=FALSE}
library(htmltools)

destination_plot2<-destination_plot+ theme(legend.position=c(0.5, 0.8))
destination_plot2
```
...
<br>
<br>
* Exports to Northern Ireland, `r text_annual_export_NI` on an annual basis and contributed `r round(Contribution_annual_growth$NI[length(Contribution_annual_growth$NI)],1)` percentage points (representing `r text_annual_contribution_export_NI_TOTAL` of the total) in `r current_date`.
<br>
<br>
* Exports to the Euro Area, `r text_annual_export_Euro_Area` on an annual basis and contributed `r round(EURO_AREA_CONTRIBUTION_ANNUAL_GROWTH$EA[length(Contribution_annual_growth$Germany)],1)` percentage points (representing `r text_annual_contribution_export_EURO_AREA_TOTAL` of the total) in `r current_date`.
<br>
<br>
* Exports to China, `r text_annual_export_China` on an annual basis and contributed `r round(Contribution_annual_growth$China[length(Contribution_annual_growth$China)],1)` percentage points (representing `r text_annual_contribution_export_China_TOTAL` of the total) in `r current_date`.
<br>
<br>
* Outside of our main trading partners,exports `r text_annual_export_Other` on an annual basis and contributed `r round(Other_contribution_export$TOTAL[length(Other_contribution_export$TOTAL)],1)` percentage points (representing `r text_annual_contribution_export_Other_TOTAL` of the total) in `r current_date`.
</br>
...
#Year to Date calculation
YTD_2022_annual_UK_EXPORT<- 100*(sum(Exports_UK$GB["2023"])-sum(Exports_UK$GB["2022"][1:length(Exports_UK$GB["2023"])]))/sum(Exports_UK$GB["2022"][1:length(Exports_UK$GB["2023"])])
YTD_2022_annual_text_UK_EXPORT<-conditional(YTD_2022_annual_UK_EXPORT)

YTD_2022_annual_GB_EXPORT<- 100*(sum(Total_Export_Country$GB["2023"])-sum(Total_Export_Country$GB["2022"][1:length(Total_Export_Country$GB["2023"])]))/sum(Total_Export_Country$GB["2022"][1:length(Total_Export_Country$GB["2023"])])
YTD_2022_annual_text_GB_EXPORT<-conditional(YTD_2022_annual_GB_EXPORT)


YTD_2022_annual_NI_EXPORT<- 100*(sum(Total_Export_Country$NI["2023"])-sum(Total_Export_Country$NI["2022"][1:length(Total_Export_Country$NI["2023"])]))/sum(Total_Export_Country$NI["2022"][1:length(Total_Export_Country$NI["2023"])])
...
YTD_2022_FB_UK_EXPORTS<- 100*(sum(FB_UK_EXPORTS$FB_UK_EXPORTS["2023"])-sum(FB_UK_EXPORTS$FB_UK_EXPORTS["2022"][1:length(FB_UK_EXPORTS$FB_UK_EXPORTS["2023"])]))/sum(FB_UK_EXPORTS$FB_UK_EXPORTS["2022"][1:length(FB_UK_EXPORTS$FB_UK_EXPORTS["2023"])])
...
YTD_2022_PHARMA_UK_EXPORTS<- 100*(sum(Pharma_UK_EXPORTS$Pharma_UK_EXPORTS["2023"])-sum(Pharma_UK_EXPORTS$Pharma_UK_EXPORTS["2022"][1:length(Pharma_UK_EXPORTS$Pharma_UK_EXPORTS["2023"])]))/sum(Pharma_UK_EXPORTS$Pharma_UK_EXPORTS["2022"][1:length(Pharma_UK_EXPORTS$Pharma_UK_EXPORTS["2023"])])
...
* In `r current_date` exports to the UK `r annual_text_UK_EXPORT` on an annual basis. Over the same period, exports to Great Britian `r annual_text_GB_EXPORT` and exports to Northern Ireland `r annual_text_NI_EXPORT`
<br>
<br>
* In the year to date, Exports to the UK `r YTD_2022_annual_text_UK_EXPORT`. Exports to mainland Great Britian `r YTD_2022_annual_text_GB_EXPORT` whilst exports to Northern Ireland `r YTD_2022_annual_text_NI_EXPORT` over the same period. 
<br>
<br>
* In year to date terms, pharma exports to the UK `r YTD_2022_annual_text_UK_PHARMA_EXPORT` whilst Food & Beverage Exports to the UK `r YTD_2022_annual_text_UK_FB_EXPORT`. 
<br>
<br>
* **<span style="color:green">High Contribution Warning:</span> ** At a subcomponent level, `r high_contribution_GB_PROD` reported the highest contribution to annual export growth to Great Britian, contributing  `r high_contribution_value_GB` percentage points to growth, as annual export growth in `r high_contribution_GB_PROD`  `r High_contribution_growth_rate_GB_text`.  
<br>
<br>
* **<span style="color:darkred">Big fall Warning:</span> ** At a subcomponent level, `r Low_contribution_GB` reported the largest drag on annual export growth to Great Britian, contributing `r Low_contribution_GB_value` percentage points to growth, as annual exports in `r Low_contribution_GB` `r Low_contribution_growth_rate_text_GB`. 
<br>
<br>
* **<span style="color:green">High Contribution Warning:</span> ** At a subcomponent level, `r high_contribution_NI_PROD` reported the highest contribution to annual export growth to Northern Ireland, contributing  `r high_contribution_value_NI` percentage points to growth, as annual export growth in `r high_contribution_NI_PROD`  `r High_contribution_growth_rate_NI_text`.  
...
Live_animals_00<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Live animals except fish etc. (00)") %>% select(-Country,-Commodity.group))
...
meat_01<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Meat and meat preparations (01)") %>% select(-Country,-Commodity.group))
...
Dairy_02<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Dairy products and birds eggs (02)") %>% select(-Country,-Commodity.group))
...
Fish_03<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Fish, crustaceans, molluscs and preparations thereof (03)") %>% select(-Country,-Commodity.group))
...
Cereal_04<-t(subset(Ireland_exports,Commodity.group=="Cereals and cereal preparations (04)") %>% select(-Country,-Commodity.group))
...
Veg_05<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Vegetables and fruit (05)") %>% select(-Country,-Commodity.group))
...
Sugar_06<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Sugar, sugar preparations and honey (06)") %>% select(-Country,-Commodity.group))
...
Coffee_07<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Coffee, tea, cocoa, spices and manufactures thereof (07)") %>% select(-Country,-Commodity.group))
...
animal_feed_08<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Feeding stuffs for animals, excluding unmilled cereals (08)") %>% select(-Country,-Commodity.group))
...
Miscellaneous_09<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Miscellaneous edible products and preparations (09)") %>% select(-Country,-Commodity.group))
...
#Beverages (11)                                                      
Beverages_11<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Beverages (11)") %>% select(-Country,-Commodity.group))
...
Tobacco_12<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Tobacco and tobacco manufactures (12)") %>% select(-Country,-Commodity.group))
...
Hides_21<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Hides, skins and furskins, raw (21)") %>% select(-Country,-Commodity.group))
...
oilseeds_22<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Oilseeds and oleaginous fruit (22)") %>% select(-Country,-Commodity.group))
...
Crude_rubber_23<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Crude rubber, including synthetic and reclaimed rubber (23)") %>% select(-Country,-Commodity.group))
...
Cork_24<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Cork and wood (24)") %>% select(-Country,-Commodity.group))
...
Pulp_25<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Pulp and waste paper (25)") %>% select(-Country,-Commodity.group))
...
Textile_fibres_26<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Textile fibres, excluding wool tops, and their wastes (26)") %>% select(-Country,-Commodity.group))
...
Crude_fertilisers_27<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Crude fertilisers and minerals, excluding coal, petroleum etc. (27)") %>% select(-Country,-Commodity.group))
...
Metalliferous_ores_28<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Metalliferous ores and metal scrap (28)") %>% select(-Country,-Commodity.group))
...
Crude_animal_and_vegetable_materials_29<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Crude animal and vegetable materials, n.e.s. (29)") %>% select(-Country,-Commodity.group))
...
Coal_32<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Coal, coke and briquettes (32)") %>% select(-Country,-Commodity.group))
...
Petroleum_33<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Petroleum, petroleum products and related materials (33)") %>% select(-Country,-Commodity.group))
...
Gas_34<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Gas, natural and manufactured (34)") %>% select(-Country,-Commodity.group))
...
Electric_current_35<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Electric current (35)") %>% select(-Country,-Commodity.group))
...
Animal_oils_and_fats_41<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Animal oils and fats (41)") %>% select(-Country,-Commodity.group))
...
Fixed_vegetable_oils_and_fats_42<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Fixed vegetable oils and fats (42)") %>% select(-Country,-Commodity.group))
...
Animal_and_vegetable_oils_43<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Animal and vegetable oils and fats, processed, and waxes (43)") %>% select(-Country,-Commodity.group))
...
Organic_chemicals_51<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Organic chemicals (51)") %>% select(-Country,-Commodity.group))
...
Inorganic_chemicals_52<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Inorganic chemicals (52)") %>% select(-Country,-Commodity.group))
...
Dyeing_tanning_53<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Dyeing, tanning and colouring materials (53)") %>% select(-Country,-Commodity.group))
...
Medicinal_and_pharma_54<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Medicinal and pharmaceutical products (54)") %>% select(-Country,-Commodity.group))
...
Essential_oils_55<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Essential oils, perfume materials, toilet preparations etc. (55)") %>% select(-Country,-Commodity.group))
...
Fertilisers_56<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Fertilisers, manufactured (56)") %>% select(-Country,-Commodity.group))
...
Plastics_57<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Plastics in primary forms (57)") %>% select(-Country,-Commodity.group))
...
Plastics_non_primary_58<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Plastics in non-primary forms (58)") %>% select(-Country,-Commodity.group))
...
Chemical_materials_59<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Chemical materials and products, n.e.s. (59)") %>% select(-Country,-Commodity.group))
...
Leather_61<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Leather, leather manufactures and dressed furskins (61)") %>% select(-Country,-Commodity.group))
...
Rubber_manufactures_62<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Rubber manufactures, n.e.s. (62)") %>% select(-Country,-Commodity.group))
...
Cork_and_wood_manufactures_63<-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Cork and wood manufactures, excluding furniture (63)") %>% select(-Country,-Commodity.group))
...
Paper_paperboard_64 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Paper, paperboard and articles of paper pulp, paper etc. (64)") %>% select(-Country,-Commodity.group))
...
Textile_yarn_65 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Textile yarn, fabrics, made-up articles and related products (65)") %>% select(-Country,-Commodity.group))
...
Non_metallic_mineral_66 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Non-metallic mineral manufactures, n.e.s. (66)") %>% select(-Country,-Commodity.group))
...
#Iron and steel (67)
Iron_and_steel_67 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Iron and steel (67)") %>% select(-Country,-Commodity.group))
...
Non_ferrous_metals_68 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Non-ferrous metals (68)") %>% select(-Country,-Commodity.group))
...
Manufactures_of_metal_69 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Manufactures of metal, n.e.s. (69)") %>% select(-Country,-Commodity.group))
...
Power_generating_machinery_71 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Power generating machinery and equipment (71)") %>% select(-Country,-Commodity.group))
...
Machinery_specialised_for_particular_industries_72 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Machinery specialised for particular industries (72)") %>% select(-Country,-Commodity.group))
...
Metalworking_machinery_73 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Metalworking machinery (73)") %>% select(-Country,-Commodity.group))
...
General_industrial_machinery_74 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="General industrial machinery and parts, n.e.s. (74)") %>% select(-Country,-Commodity.group))
...
Office_machines_and_automatic_data_processing_equipment_75 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Office machines and automatic data processing equipment (75)") %>% select(-Country,-Commodity.group))
...
Telecommunications_and_sound_recording_76 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Telecommunications and sound recording, reproducing equipment (76)") %>% select(-Country,-Commodity.group))
...
Electrical_machinery_77 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Electrical machinery, appliances etc., n.e.s. (77)") %>% select(-Country,-Commodity.group))
...
Road_vehicles_78 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Road vehicles (78)") %>% select(-Country,-Commodity.group))
...
Other_transport_equipment_79 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Other transport equipment (79)") %>% select(-Country,-Commodity.group))
...
Prefab_buildings_plumbing_and_electrical_81 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Prefab buildings; plumbing and electrical fixtures and fittings (81)") %>% select(-Country,-Commodity.group))
...
Furniture_and_parts_thereof_82 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Furniture and parts thereof (82)") %>% select(-Country,-Commodity.group))
...
Travel_goods_handbags_and_similar_containers_83 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Travel goods, handbags and similar containers (83)") %>% select(-Country,-Commodity.group))
...
Articles_of_apparel_84 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Articles of apparel and clothing accessories (84)") %>% select(-Country,-Commodity.group))
...
Footwear_85 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Footwear (85)") %>% select(-Country,-Commodity.group))
...
Professional_scientific_and_controlling_apparatus_87 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Professional, scientific and controlling apparatus (87)") %>% select(-Country,-Commodity.group))
...
Photographic_apparatus_88 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Photographic apparatus, optical goods, watches and clocks (88)") %>% select(-Country,-Commodity.group))
...
Miscellaneous_manufactured_articles_89 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Miscellaneous manufactured articles, n.e.s. (89)") %>% select(-Country,-Commodity.group))
...
Commodities_and_transactions_9 <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Commodities and transactions n.e.s. (9)") %>% select(-Country,-Commodity.group))
...
Unclassified_estimates <-t(subset(Ireland_exports,Ireland_Exports["2014-11-01"]=="Unclassified estimates") %>% select(-Country,-Commodity.group))
...
YTD_Food_Beverage<- 100*(sum(FOOD_and_Beverage["2023"])-sum(FOOD_and_Beverage["2022/"][1:length(FOOD_and_Beverage["2023/"])]))/sum(FOOD_and_Beverage["2022/"][1:length(FOOD_and_Beverage["2023/"])])
YTD_Food_Beverage_text<-conditional(YTD_Food_Beverage)

length_current_year<-length(FOOD_and_Beverage["2023/"])
...
YTD_Pharma<- 100*(sum(Chemicals_and_related_products["2023"])-sum(Chemicals_and_related_products["2022/"][1:length(Chemicals_and_related_products["2023/"])]))/sum(Chemicals_and_related_products["2022/"][1:length(Chemicals_and_related_products["2023/"])])
YTD_Pharma_text<-conditional(YTD_Pharma)



Pharma_Share_2021<- sum(Chemicals_and_related_products["2022"][1:length(Total_Export_Country$TOTAL["2023"])])/(sum(Total_Export_Country$TOTAL["2022"][1:length(Total_Export_Country$TOTAL["2023"])]))
...
summary_contribution_Product<-data.frame(merge(Contribution_annual_growth_product$`Food & Beverage`["2020/"],Contribution_annual_growth_product$`semi Conductors`["2020/"],Contribution_annual_growth_product$Pharma["2020/"],Contribution_annual_growth_product$`Other Core M&E`["2020/"],Contribution_annual_growth_product$`Miscellaneous Medical Devices`["2020/"],Contribution_annual_growth_product$Other["2020/"]),index(Contribution_annual_growth_product["2020/"]))
...
product_contribution<-ggplot(data=summary_contribution_melt_Product, aes(y=value, x=Date, fill=variable)) + 
  geom_bar(position="stack", stat="identity")+theme(legend.position=c(0.8, 0.2),plot.caption = element_text(hjust=0))+
  labs(x="",
...
product_contribution+theme(legend.position = c(0.2, 0.8))
...
colnames(latest_annual_prod_growth)<-c("Live animals","meat","Dairy","Fish","Cereal","Veg","Sugar","Coffee","animal feed","Miscellaneous","Beverages","Tobacco","Hides","oilseeds","Crude rubber","Cork","Pulp","Textile fibres","Crude fertilisers","Metalliferous ores","Crude animal and vegetable materials","Coal","Petroleum","Gas","Electric current","Animal oils and fats","Fixed vegetable oils and fats", "Animal and vegetable oils","Organic chemicals","Inorganic chemicals","Dyeing tanning","Medicinal and pharma","Essential oils","Fertilisers","Plastics","Plastics non primary","Chemical materials","Leather","Rubber manufactures","Cork and wood manufactures","Paper paperboard","Textile yarn","Non metallic mineral","Iron and steel","Non ferrous metals","Manufactures of metal","Power generating machinery","Machinery specialised for particular industries","Metalworking machinery","General industrial machinery","Office machines and automatic data processing equipment", "Telecommunications and sound recording","Electrical machinery","Road vehicles","Other transport equipment","Prefab buildings plumbing and electrical","Furniture and parts thereof","Travel goods handbags and similar containers","Articles of apparel","Footwear","Professional sc.ientific and controlling apparatus","Photographic apparatus","Miscellaneous manufactured articles","Commodities and transactions","Unclassified_estimates")                                    
...
<br>
<br>
* **<span style="color:green">High Contribution Warning:</span> ** At a subcomponent level `r high_contribution` reported the highest contribution to annual growth over the month, contributing  `r high_contribution_value` percentage points to growth, as annual growth in `r current_date` `r High_contribution_growth_rate_text`.  
<br>
<br>
* **<span style="color:darkred">Big fall Warning:</span> ** At a subcomponent level `r Low_contribution` reported the largest drag on annual growth over the month, contributing `r Low_contribution_value` percentage points to growth, as annual growth in `r current_date` `r Low_contribution_growth_rate_text`. 
<br>
<br>
***
...
#Austria
Austria_Imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Austria") %>% select(-Country))
colnames(Austria_Imports) <-Austria_Imports[1,]
Austria_Imports<-Austria_Imports[-c(1),]
Austria_Imports<-Austria_Imports[,-c(10)]
...
for (i in 1:length(index(Austria_Imports_xts["2015/"]))) {
  Austria_sum_import[i]<-sum(as.numeric(Austria_Imports_xts[i]),na.rm = TRUE)
}
...
#Australia
Australia_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Australia") %>% select(-Country))
colnames(Australia_imports) <-Australia_imports[1,]
Australia_imports<-Australia_imports[-c(1),]
Australia_imports<-Australia_imports[,-c(10)]
...
for (i in 1:length(index(Australia_imports_xts["2015/"]))) {
  Australia_sum_import[i]<-sum(as.numeric(Australia_imports_xts[i]),na.rm = TRUE)
}
...
#Belgium
Belgium_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Belgium") %>% select(-Country))
colnames(Belgium_imports) <-Belgium_imports[1,]
Belgium_imports<-Belgium_imports[-c(1),]
Belgium_imports<-Belgium_imports[,-c(10)]
...
for (i in 1:length(index(Belgium_imports_xts["2015/"]))) {
  Belgium_sum_import[i]<-sum(as.numeric(Belgium_imports_xts[i]),na.rm = TRUE)
}
...
#Bulgaria
Bulgaria_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Bulgaria") %>% select(-Country))
colnames(Bulgaria_imports) <-Bulgaria_imports[1,]
Bulgaria_imports<-Bulgaria_imports[-c(1),]
Bulgaria_imports<-Bulgaria_imports[,-c(10)]
...
for (i in 1:length(index(Bulgaria_imports_xts["2015/"]))) {
  Bulgaria_sum_import[i]<-sum(as.numeric(Bulgaria_imports_xts[i]),na.rm = TRUE)
}
...
#Brazil 
Brazil_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Brazil") %>% select(-Country))
colnames(Brazil_imports) <-Brazil_imports[1,]
Brazil_imports<-Brazil_imports[-c(1),]
Brazil_imports<-Brazil_imports[,-c(10)]
...
for (i in 1:length(index(Brazil_imports_xts["2015/"]))) {
  Brazil_sum_import[i]<-sum(as.numeric(Brazil_imports_xts[i]),na.rm = TRUE)
}
...
#Canada 
Canada_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Canada") %>% select(-Country))
colnames(Canada_imports) <-Canada_imports[1,]
Canada_imports<-Canada_imports[-c(1),]
Canada_imports<-Canada_imports[,-c(10)]
...
for (i in 1:length(index(Canada_imports_xts["2015/"]))) {
  Canada_sum_import[i]<-sum(as.numeric(Canada_imports_xts[i]),na.rm = TRUE)
}
...
#Switzerland 
Switzerland_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Switzerland") %>% select(-Country))
colnames(Switzerland_imports) <-Switzerland_imports[1,]
Switzerland_imports<-Switzerland_imports[-c(1),]
Switzerland_imports<-Switzerland_imports[,-c(10)]
...
for (i in 1:length(index(Switzerland_imports_xts["2015/"]))) {
  Switzerland_sum_import[i]<-sum(as.numeric(Switzerland_imports_xts[i]),na.rm = TRUE)
}
...
#China 
China_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="China") %>% select(-Country))
colnames(China_imports) <-China_imports[1,]
China_imports<-China_imports[-c(1),]
China_imports<-China_imports[,-c(10)]
...
for (i in 1:length(index(China_imports_xts["2015/"]))) {
  China_sum_import[i]<-sum(as.numeric(China_imports_xts[i]),na.rm = TRUE)
}
...
#Cyprus 
Cyprus_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Cyprus") %>% select(-Country))
colnames(Cyprus_imports) <-Cyprus_imports[1,]
Cyprus_imports<-Cyprus_imports[-c(1),]
Cyprus_imports<-Cyprus_imports[,-c(10)]
...
for (i in 1:length(index(Cyprus_imports_xts["2015/"]))) {
  Cyprus_sum_import[i]<-sum(as.numeric(Cyprus_imports_xts[i]),na.rm = TRUE)
}
...
#Czech Republic
Czech_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Czech Republic") %>% select(-Country))
colnames(Czech_imports) <-Czech_imports[1,]
Czech_imports<-Czech_imports[-c(1),]

Czech_imports<-Czech_imports[,-c(10)]
...
for (i in 1:length(index(Czech_imports_xts["2015/"]))) {
  Czech_sum_import[i]<-sum(as.numeric(Czech_imports_xts[i]),na.rm = TRUE)
}
...
#Germany
Germany_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Germany") %>% select(-Country))
colnames(Germany_imports) <-Germany_imports[1,]
Germany_imports<-Germany_imports[-c(1),]

Germany_imports<-Germany_imports[,-c(10)]
...
for (i in 1:length(index(Germany_imports_xts["2015/"]))) {
  Germany_sum_import[i]<-sum(as.numeric(Germany_imports_xts[i]),na.rm = TRUE)
}
...
#Denmark 
Denmark_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Denmark") %>% select(-Country))
colnames(Denmark_imports) <-Denmark_imports[1,]
Denmark_imports<-Denmark_imports[-c(1),]
Denmark_imports<-Denmark_imports[,-c(10)]
...
for (i in 1:length(index(Denmark_imports_xts["2015/"]))) {
  Denmark_sum_import[i]<-sum(as.numeric(Denmark_imports_xts[i]),na.rm = TRUE)
}
...
#Estonia 
Estonia_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Estonia") %>% select(-Country))
colnames(Estonia_imports) <-Estonia_imports[1,]
Estonia_imports<-Estonia_imports[-c(1),]
Estonia_imports<-Estonia_imports[,-c(10)]
...
for (i in 1:length(index(Estonia_imports_xts["2015/"]))) {
  Estonia_sum_import[i]<-sum(as.numeric(Estonia_imports_xts[i]),na.rm = TRUE)
}
...
#Spain 
Spain_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Spain") %>% select(-Country))
colnames(Spain_imports) <-Spain_imports[1,]
Spain_imports<-Spain_imports[-c(1),]
Spain_imports<-Spain_imports[,-c(10)]
...
for (i in 1:length(index(Spain_imports_xts["2015/"]))) {
  Spain_sum_import[i]<-sum(as.numeric(Spain_imports_xts[i]),na.rm = TRUE)
}
...
#Finland 
Finland_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Finland") %>% select(-Country))
colnames(Finland_imports) <-Finland_imports[1,]
Finland_imports<-Finland_imports[-c(1),]
Finland_imports<-Finland_imports[,-c(10)]
...
for (i in 1:length(index(Finland_imports_xts["2015/"]))) {
  Finland_sum_import[i]<-sum(as.numeric(Finland_imports_xts[i]),na.rm = TRUE)
}
...
#France
France_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="France") %>% select(-Country))
colnames(France_imports) <-France_imports[1,]
France_imports<-France_imports[-c(1),]
France_imports<-France_imports[,-c(10)]
...
for (i in 1:length(index(France_imports_xts["2015/"]))) {
  France_sum_import[i]<-sum(as.numeric(France_imports_xts[i]),na.rm = TRUE)
}
...
#Greece
Greece_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Greece") %>% select(-Country))
colnames(Greece_imports) <-Greece_imports[1,]
Greece_imports<-Greece_imports[-c(1),]
Greece_imports<-Greece_imports[,-c(10)]
...
for (i in 1:length(index(Greece_imports_xts["2015/"]))) {
  Greece_sum_import[i]<-sum(as.numeric(Greece_imports_xts[i]),na.rm = TRUE)
}
...
##Croatia
Croatia_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Croatia") %>% select(-Country))
colnames(Croatia_imports) <-Croatia_imports[1,]
Croatia_imports<-Croatia_imports[-c(1),]
Croatia_imports<-Croatia_imports[,-c(10)]
...
for (i in 1:length(index(Croatia_imports_xts["2015/"]))) {
  Croatia_sum_import[i]<-sum(as.numeric(Croatia_imports_xts[i]),na.rm = TRUE)
}
...
#Hungary
Hungary_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Hungary") %>% select(-Country))
colnames(Hungary_imports) <-Hungary_imports[1,]
Hungary_imports<-Hungary_imports[-c(1),]
Hungary_imports<-Hungary_imports[,-c(10)]
...
for (i in 1:length(index(Hungary_imports_xts["2015/"]))) {
  Hungary_sum_import[i]<-sum(as.numeric(Hungary_imports_xts[i]),na.rm = TRUE)
}
...
#India
India_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="India") %>% select(-Country))
colnames(India_imports) <-India_imports[1,]
India_imports<-India_imports[-c(1),]
India_imports<-India_imports[,-c(10)]
...
for (i in 1:length(index(India_imports_xts["2015/"]))) {
  India_sum_import[i]<-sum(as.numeric(India_imports_xts[i]),na.rm = TRUE)
}
...
#Italy
Italy_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Italy") %>% select(-Country))
colnames(Italy_imports) <-Italy_imports[1,]
Italy_imports<-Italy_imports[-c(1),]
Italy_imports<-Italy_imports[,-c(10)]
...
for (i in 1:length(index(Italy_imports_xts["2015/"]))) {
  Italy_sum_import[i]<-sum(as.numeric(Italy_imports_xts[i]),na.rm = TRUE)
}
...
Japan_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Japan") %>% select(-Country))
colnames(Japan_imports) <-Japan_imports[1,]
Japan_imports<-Japan_imports[-c(1),]
Japan_imports<-Japan_imports[,-c(10)]
...
for (i in 1:length(index(Japan_imports_xts["2015/"]))) {
  Japan_sum_import[i]<-sum(as.numeric(Japan_imports_xts[i]),na.rm = TRUE)
}
...
#South Korea
Korea_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="South Korea") %>% select(-Country))
colnames(Korea_imports) <-Korea_imports[1,]
Korea_imports<-Korea_imports[-c(1),]
Korea_imports<-Korea_imports[,-c(10)]
...
for (i in 1:length(index(Korea_imports_xts["2015/"]))) {
  Korea_sum_import[i]<-sum(as.numeric(Korea_imports_xts[i]),na.rm = TRUE)
}
...
#Lithuania
Lithuania_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Lithuania") %>% select(-Country))
colnames(Lithuania_imports) <-Lithuania_imports[1,]
Lithuania_imports<-Lithuania_imports[-c(1),]
Lithuania_imports<-Lithuania_imports[,-c(10)]
...
for (i in 1:length(index(Lithuania_imports_xts["2015/"]))) {
  Lithuania_sum_import[i]<-sum(as.numeric(Lithuania_imports_xts[i]),na.rm = TRUE)
}
...
#Luxembourg 
Luxembourg_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Luxembourg") %>% select(-Country))
colnames(Luxembourg_imports) <-Luxembourg_imports[1,]
Luxembourg_imports<-Luxembourg_imports[-c(1),]
Luxembourg_imports<-Luxembourg_imports[,-c(10)]
...
for (i in 1:length(index(Luxembourg_imports_xts["2015/"]))) {
  Luxembourg_sum_import[i]<-sum(as.numeric(Luxembourg_imports_xts[i]),na.rm = TRUE)
}
...
#Latvia 
Latvia_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Latvia") %>% select(-Country))
colnames(Latvia_imports) <-Latvia_imports[1,]
Latvia_imports<-Latvia_imports[-c(1),]
Latvia_imports<-Latvia_imports[,-c(10)]
...
for (i in 1:length(index(Latvia_imports_xts["2015/"]))) {
  Latvia_sum_import[i]<-sum(as.numeric(Latvia_imports_xts[i]),na.rm = TRUE)
}
...
#Malta 
Malta_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Malta") %>% select(-Country))
colnames(Malta_imports) <-Malta_imports[1,]
Malta_imports<-Malta_imports[-c(1),]
Malta_imports<-Malta_imports[,-c(10)]
...
for (i in 1:length(index(Malta_imports_xts["2015/"]))) {
  Malta_sum_import[i]<-sum(as.numeric(Malta_imports_xts[i]),na.rm = TRUE)
}
...
#Mexico 
Mexico_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Mexico") %>% select(-Country))
colnames(Mexico_imports) <-Mexico_imports[1,]
Mexico_imports<-Mexico_imports[-c(1),]
Mexico_imports<-Mexico_imports[,-c(10)]
...
for (i in 1:length(index(Mexico_imports_xts["2015/"]))) {
  Mexico_sum_import[i]<-sum(as.numeric(Mexico_imports_xts[i]),na.rm = TRUE)
}
...
#Malaysia 
Malaysia_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Malaysia") %>% select(-Country))
colnames(Malaysia_imports) <-Malaysia_imports[1,]
Malaysia_imports<-Malaysia_imports[-c(1),]
Malaysia_imports<-Malaysia_imports[,-c(10)]
...
for (i in 1:length(index(Malaysia_imports_xts["2015/"]))) {
  Malaysia_sum_import[i]<-sum(as.numeric(Malaysia_imports_xts[i]),na.rm = TRUE)
}
...
#Netherlands 
Netherlands_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Netherlands") %>% select(-Country))
colnames(Netherlands_imports) <-Netherlands_imports[1,]
Netherlands_imports<-Netherlands_imports[-c(1),]
Netherlands_imports<-Netherlands_imports[,-c(10)]
...
for (i in 1:length(index(Netherlands_imports_xts["2015/"]))) {
  Netherlands_sum_import[i]<-sum(as.numeric(Netherlands_imports_xts[i]),na.rm = TRUE)
}
...
#Norway  
Norway_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Norway") %>% select(-Country))
colnames(Norway_imports) <-Norway_imports[1,]
Norway_imports<-Norway_imports[-c(1),]
Norway_imports<-Norway_imports[,-c(10)]
...
for (i in 1:length(index(Norway_imports_xts["2015/"]))) {
  Norway_sum_import[i]<-sum(as.numeric(Norway_imports_xts[i]),na.rm = TRUE)
}
...
#Poland  
Poland_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Poland") %>% select(-Country))
colnames(Poland_imports) <-Poland_imports[1,]
Poland_imports<-Poland_imports[-c(1),]
Poland_imports<-Poland_imports[,-c(10)]
...
for (i in 1:length(index(Poland_imports_xts["2015/"]))) {
  Poland_sum_import[i]<-sum(as.numeric(Poland_imports_xts[i]),na.rm = TRUE)
}
...
#Portugal  
Portugal_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Portugal") %>% select(-Country))
colnames(Portugal_imports) <-Portugal_imports[1,]
Portugal_imports<-Portugal_imports[-c(1),]
Portugal_imports<-Portugal_imports[,-c(10)]
...
for (i in 1:length(index(Portugal_imports_xts["2015/"]))) {
  Portugal_sum_import[i]<-sum(as.numeric(Portugal_imports_xts[i]),na.rm = TRUE)
}
...
#Romania  
Romania_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Romania") %>% select(-Country))
colnames(Romania_imports) <-Romania_imports[1,]
Romania_imports<-Romania_imports[-c(1),]
Romania_imports<-Romania_imports[,-c(10)]
...
for (i in 1:length(index(Romania_imports_xts["2015/"]))) {
  Romania_sum_import[i]<-sum(as.numeric(Romania_imports_xts[i]),na.rm = TRUE)
}
...
#Russia  
Russia_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Russia") %>% select(-Country))
colnames(Russia_imports) <-Russia_imports[1,]
Russia_imports<-Russia_imports[-c(1),]
Russia_imports<-Russia_imports[,-c(10)]
...
for (i in 1:length(index(Russia_imports_xts["2015/"]))) {
  Russia_sum_import[i]<-sum(as.numeric(Russia_imports_xts[i]),na.rm = TRUE)
}
...
#Saudi Arabia  
Saudi_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Saudi Arabia") %>% select(-Country))
colnames(Saudi_imports) <-Saudi_imports[1,]
Saudi_imports<-Saudi_imports[-c(1),]
Saudi_imports<-Saudi_imports[,-c(10)]
...
for (i in 1:length(index(Saudi_imports_xts["2015/"]))) {
  Saudi_sum_import[i]<-sum(as.numeric(Saudi_imports_xts[i]),na.rm = TRUE)
}
...
#Sweden  
Sweden_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Sweden") %>% select(-Country))
colnames(Sweden_imports) <-Sweden_imports[1,]
Sweden_imports<-Sweden_imports[-c(1),]
Sweden_imports<-Sweden_imports[,-c(10)]
...
for (i in 1:length(index(Sweden_imports_xts["2015/"]))) {
  Sweden_sum_import[i]<-sum(as.numeric(Sweden_imports_xts[i]),na.rm = TRUE)
}
...
#Singapore  
Singapore_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Singapore") %>% select(-Country))
colnames(Singapore_imports) <-Singapore_imports[1,]
Singapore_imports<-Singapore_imports[-c(1),]
Singapore_imports<-Singapore_imports[,-c(10)]
...
for (i in 1:length(index(Singapore_imports_xts["2015/"]))) {
  Singapore_sum_import[i]<-sum(as.numeric(Singapore_imports_xts[i]),na.rm = TRUE)
}
...
#Slovenia  
Slovenia_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Slovenia") %>% select(-Country))
colnames(Slovenia_imports) <-Slovenia_imports[1,]
Slovenia_imports<-Slovenia_imports[-c(1),]
Slovenia_imports<-Slovenia_imports[,-c(10)]
...
for (i in 1:length(index(Slovenia_imports_xts["2015/"]))) {
  Slovenia_sum_import[i]<-sum(as.numeric(Slovenia_imports_xts[i]),na.rm = TRUE)
}
...
#Slovakia  
Slovakia_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Slovakia") %>% select(-Country))
colnames(Slovakia_imports) <-Slovakia_imports[1,]
Slovakia_imports<-Slovakia_imports[-c(1),]
Slovakia_imports<-Slovakia_imports[,-c(10)]
...
for (i in 1:length(index(Slovakia_imports_xts["2015/"]))) {
  Slovakia_sum_import[i]<-sum(as.numeric(Slovakia_imports_xts[i]),na.rm = TRUE)
}
...
#Thailand  
Thailand_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Thailand") %>% select(-Country))
colnames(Thailand_imports) <-Thailand_imports[1,]
Thailand_imports<-Thailand_imports[-c(1),]
Thailand_imports<-Thailand_imports[,-c(10)]
...
for (i in 1:length(index(Thailand_imports_xts["2015/"]))) {
  Thailand_sum_import[i]<-sum(as.numeric(Thailand_imports_xts[i]),na.rm = TRUE)
}
...
#Turkey  
Turkey_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Turkey") %>% select(-Country))
colnames(Turkey_imports) <-Turkey_imports[1,]
Turkey_imports<-Turkey_imports[-c(1),]
Turkey_imports<-Turkey_imports[,-c(10)]
...
for (i in 1:length(index(Turkey_imports_xts["2015/"]))) {
  Turkey_sum_import[i]<-sum(as.numeric(Turkey_imports_xts[i]),na.rm = TRUE)
}
...
#Taiwan  
Taiwan_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Taiwan") %>% select(-Country))
colnames(Taiwan_imports) <-Taiwan_imports[1,]
Taiwan_imports<-Taiwan_imports[-c(1),]
Taiwan_imports<-Taiwan_imports[,-c(10)]
...
for (i in 1:length(index(Taiwan_imports_xts["2015/"]))) {
  Taiwan_sum_import[i]<-sum(as.numeric(Taiwan_imports_xts[i]),na.rm = TRUE)
}
...
#USA  
USA_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="USA") %>% select(-Country))
colnames(USA_imports) <-USA_imports[1,]
USA_imports<-USA_imports[-c(1),]
USA_imports<-USA_imports[,-c(10)]
...
for (i in 1:length(index(USA_imports_xts["2015/"]))) {
  USA_sum_import[i]<-sum(as.numeric(USA_imports_xts[i]),na.rm = TRUE)
}
...
#Great Britian  
GB_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Great Britain") %>% select(-Country))
colnames(GB_imports) <-GB_imports[1,]
GB_imports<-GB_imports[-c(1),]
GB_imports<-GB_imports[,-c(10)]
...
for (i in 1:length(index(GB_imports_xts["2015/"]))) {
  GB_sum_import[i]<-sum(as.numeric(GB_imports_xts[i]),na.rm = TRUE)
}
...
#Northern Ireland 
NI_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Northern Ireland") %>% select(-Country))
colnames(NI_imports) <-NI_imports[1,]
NI_imports<-NI_imports[-c(1),]
NI_imports<-NI_imports[,-c(10)]
...
for (i in 1:length(index(NI_imports_xts["2015/"]))) {
  NI_sum_import[i]<-sum(as.numeric(NI_imports_xts[i]),na.rm = TRUE)
}
...
#South Africa 
SA_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="South Africa") %>% select(-Country))
colnames(SA_imports) <-SA_imports[1,]
SA_imports<-SA_imports[-c(1),]
SA_imports<-SA_imports[,-c(10)]
...
for (i in 1:length(index(SA_imports_xts["2015/"]))) {
  SA_sum_import[i]<-sum(as.numeric(SA_imports_xts[i]),na.rm = TRUE)
}
...
#EU country not specified 
OTHER_EU_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="EU country not specified") %>% select(-Country))
colnames(OTHER_EU_imports) <-OTHER_EU_imports[1,]
OTHER_EU_imports<-OTHER_EU_imports[-c(1),]
OTHER_EU_imports<-OTHER_EU_imports[,-c(10)]
...
for (i in 1:length(index(OTHER_EU_imports_xts["2015/"]))) {
  OTHER_EU_sum_import[i]<-sum(as.numeric(OTHER_EU_imports_xts[i]),na.rm = TRUE)
}
...
#OTHER 
OTHER_imports<- t(subset(Ireland_imports,Ireland_Imports["2014-12-01"]=="Other countries") %>% select(-Country))
colnames(OTHER_imports) <-OTHER_imports[1,]
OTHER_imports<-OTHER_imports[-c(1),]
OTHER_imports<-OTHER_imports[,-c(10)]
...
for (i in 1:length(index(OTHER_imports_xts["2015/"]))) {
  OTHER_sum_import[i]<-sum(as.numeric(OTHER_imports_xts[i]),na.rm = TRUE)
}
...
summary_contribution_Imports<-data.frame(merge(Contribution_annual_growth_Import$USA["2020/"],Contribution_annual_growth_Import$Germany["2020/"],Contribution_annual_growth_Import$GB["2020/"],Contribution_annual_growth_Import$NI["2020/"],Contribution_annual_growth_Import$Switzerland["2020/"],Contribution_annual_growth_Import$China["2020/"],Other_contribution_Imports$OTHER["2020/"]),index(Contribution_annual_growth_Import["2020/"]))
...
destination_plot_imports<-ggplot(data=summary_contribution_melt_Imports, aes(y=value, x=Date, fill=variable)) + 
  ...
  labs(x="",
       ...
       rcaption="Date Source: CSO monthly external trade data from 2020",
       y="contribution to annual growth (%)")+
...
#Live animals except fish etc. (00)
Live_animals_00<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Live animals except fish etc. (00)") %>% select(-Country,-Commodity.group))
...
#Meat and meat preparations (01)
meat_01<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Meat and meat preparations (01)") %>% select(-Country,-Commodity.group))
...
#Dairy products and birds eggs (02)                                       
Dairy_02<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Dairy products and birds eggs (02)") %>% select(-Country,-Commodity.group))
...
Fish_03<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Fish, crustaceans, molluscs and preparations thereof (03)") %>% select(-Country,-Commodity.group))
...
Cereal_04<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Cereals and cereal preparations (04)") %>% select(-Country,-Commodity.group))
...
Veg_05<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Vegetables and fruit (05)") %>% select(-Country,-Commodity.group))
...
#Sugar, sugar preparations and honey (06)      
Sugar_06<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Sugar, sugar preparations and honey (06)") %>% select(-Country,-Commodity.group))
...
#Coffee, tea, cocoa, spices and manufactures thereof (07)      
Coffee_07<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Coffee, tea, cocoa, spices and manufactures thereof (07)") %>% select(-Country,-Commodity.group))
...
#Feeding stuffs for animals, excluding unmilled cereals (08)      
animal_feed_08<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Feeding stuffs for animals, excluding unmilled cereals (08)") %>% select(-Country,-Commodity.group))
...
#Miscellaneous edible products and preparations (09)     
Miscellaneous_09<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Miscellaneous edible products and preparations (09)") %>% select(-Country,-Commodity.group))
...
#Beverages (11)                                                      
Beverages_11<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Beverages (11)") %>% select(-Country,-Commodity.group))
...
#Tobacco and tobacco manufactures (12)                                                      
Tobacco_12<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Tobacco and tobacco manufactures (12)") %>% select(-Country,-Commodity.group))
...
#Hides, skins and furskins, raw (21)                                                      
Hides_21<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Hides, skins and furskins, raw (21)") %>% select(-Country,-Commodity.group))
...
#Oilseeds and oleaginous fruit (22)                                                      
oilseeds_22<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Oilseeds and oleaginous fruit (22)") %>% select(-Country,-Commodity.group))
...
Crude_rubber_23<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Crude rubber, including synthetic and reclaimed rubber (23)") %>% select(-Country,-Commodity.group))
...
Cork_24<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Cork and wood (24)") %>% select(-Country,-Commodity.group))
...
Pulp_25<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Pulp and waste paper (25)") %>% select(-Country,-Commodity.group))
...
Textile_fibres_26<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Textile fibres, excluding wool tops, and their wastes (26)") %>% select(-Country,-Commodity.group))
...
Crude_fertilisers_27<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Crude fertilisers and minerals, excluding coal, petroleum etc. (27)") %>% select(-Country,-Commodity.group))
...
Metalliferous_ores_28<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Metalliferous ores and metal scrap (28)") %>% select(-Country,-Commodity.group))
...
Crude_animal_and_vegetable_materials_29<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Crude animal and vegetable materials, n.e.s. (29)") %>% select(-Country,-Commodity.group))
...
Coal_32<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Coal, coke and briquettes (32)") %>% select(-Country,-Commodity.group))
...
Petroleum_33<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Petroleum, petroleum products and related materials (33)") %>% select(-Country,-Commodity.group))
...
Gas_34<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Gas, natural and manufactured (34)") %>% select(-Country,-Commodity.group))
...
Electric_current_35<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Electric current (35)") %>% select(-Country,-Commodity.group))
...
Animal_oils_and_fats_41<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Animal oils and fats (41)") %>% select(-Country,-Commodity.group))
...
Fixed_vegetable_oils_and_fats_42<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Fixed vegetable oils and fats (42)") %>% select(-Country,-Commodity.group))
...
Animal_and_vegetable_oils_43<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Animal and vegetable oils and fats, processed, and waxes (43)") %>% select(-Country,-Commodity.group))
...
Organic_chemicals_51<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Organic chemicals (51)") %>% select(-Country,-Commodity.group))
...
Inorganic_chemicals_52<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Inorganic chemicals (52)") %>% select(-Country,-Commodity.group))
...
Dyeing_tanning_53<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Dyeing, tanning and colouring materials (53)") %>% select(-Country,-Commodity.group))
...
Medicinal_and_pharma_54<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Medicinal and pharmaceutical products (54)") %>% select(-Country,-Commodity.group))
...
Essential_oils_55<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Essential oils, perfume materials, toilet preparations etc. (55)") %>% select(-Country,-Commodity.group))
...
#Fertilisers, manufactured (56)
Fertilisers_56<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Fertilisers, manufactured (56)") %>% select(-Country,-Commodity.group))
...
#Plastics in primary forms (57)
Plastics_57<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Plastics in primary forms (57)") %>% select(-Country,-Commodity.group))
...
#Plastics in non-primary forms (58)
Plastics_non_primary_58<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Plastics in non-primary forms (58)") %>% select(-Country,-Commodity.group))
...
#Chemical materials and products, n.e.s. (59)
Chemical_materials_59<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Chemical materials and products, n.e.s. (59)") %>% select(-Country,-Commodity.group))
...
#Leather, leather manufactures and dressed furskins (61)
Leather_61<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Leather, leather manufactures and dressed furskins (61)") %>% select(-Country,-Commodity.group))
...
#Rubber manufactures, n.e.s. (62)
Rubber_manufactures_62<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Rubber manufactures, n.e.s. (62)") %>% select(-Country,-Commodity.group))
...
#Cork and wood manufactures, excluding furniture (63)
Cork_and_wood_manufactures_63<-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Cork and wood manufactures, excluding furniture (63)") %>% select(-Country,-Commodity.group))
...
#Paper, paperboard and articles of paper pulp, paper etc. (64)       
Paper_paperboard_64 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Paper, paperboard and articles of paper pulp, paper etc. (64)") %>% select(-Country,-Commodity.group))
...
Textile_yarn_65 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Textile yarn, fabrics, made-up articles and related products (65)") %>% select(-Country,-Commodity.group))
...
Non_metallic_mineral_66 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Non-metallic mineral manufactures, n.e.s. (66)") %>% select(-Country,-Commodity.group))
...
#Iron and steel (67)
Iron_and_steel_67 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Iron and steel (67)") %>% select(-Country,-Commodity.group))
...
#Non-ferrous metals (68)                                             
Non_ferrous_metals_68 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Non-ferrous metals (68)") %>% select(-Country,-Commodity.group))
...
#Manufactures of metal, n.e.s. (69)
Manufactures_of_metal_69 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Manufactures of metal, n.e.s. (69)") %>% select(-Country,-Commodity.group))
...
Power_generating_machinery_71 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Power generating machinery and equipment (71)") %>% select(-Country,-Commodity.group))
...
Machinery_specialised_for_particular_industries_72 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Machinery specialised for particular industries (72)") %>% select(-Country,-Commodity.group))
...
Metalworking_machinery_73 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Metalworking machinery (73)") %>% select(-Country,-Commodity.group))
...
General_industrial_machinery_74 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="General industrial machinery and parts, n.e.s. (74)") %>% select(-Country,-Commodity.group))
...
Office_machines_and_automatic_data_processing_equipment_75 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Office machines and automatic data processing equipment (75)") %>% select(-Country,-Commodity.group))
...
Telecommunications_and_sound_recording_76 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Telecommunications and sound recording, reproducing equipment (76)") %>% select(-Country,-Commodity.group))
...
Electrical_machinery_77 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Electrical machinery, appliances etc., n.e.s. (77)") %>% select(-Country,-Commodity.group))
...
Road_vehicles_78 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Road vehicles (78)") %>% select(-Country,-Commodity.group))
...
Other_transport_equipment_79 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Other transport equipment (79)") %>% select(-Country,-Commodity.group))
...
Prefab_buildings_plumbing_and_electrical_81 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Prefab buildings; plumbing and electrical fixtures and fittings (81)") %>% select(-Country,-Commodity.group))
...
#Furniture and parts thereof (82)
Furniture_and_parts_thereof_82 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Furniture and parts thereof (82)") %>% select(-Country,-Commodity.group))
...
#Travel goods, handbags and similar containers (83)
Travel_goods_handbags_and_similar_containers_83 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Travel goods, handbags and similar containers (83)") %>% select(-Country,-Commodity.group))
...
#Articles of apparel and clothing accessories (84)
Articles_of_apparel_84 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Articles of apparel and clothing accessories (84)") %>% select(-Country,-Commodity.group))
...
Footwear_85 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Footwear (85)") %>% select(-Country,-Commodity.group))
...
Professional_scientific_and_controlling_apparatus_87 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Professional, scientific and controlling apparatus (87)") %>% select(-Country,-Commodity.group))
...
Photographic_apparatus_88 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Photographic apparatus, optical goods, watches and clocks (88)") %>% select(-Country,-Commodity.group))
...
Miscellaneous_manufactured_articles_89 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Miscellaneous manufactured articles, n.e.s. (89)") %>% select(-Country,-Commodity.group))
...
Commodities_and_transactions_9 <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Commodities and transactions n.e.s. (9)") %>% select(-Country,-Commodity.group))
...
Unclassified_estimates <-t(subset(Ireland_imports,Ireland_Imports["2014-11-01"]=="Unclassified estimates") %>% select(-Country,-Commodity.group))
...
headline_indicator<-merge(Headline_Imports_growth["2021/"],Imports_excl_Mineral_fuels_growth["2021/"],Imports_excl_aircraft_growth["2021/"])
...
Imports_graph<-Imports_graph+ theme(legend.position=c(0.8, 0.2))
...
YTD_Pharma<- 100*(sum(Chemicals_and_related_products["2023"])-sum(Chemicals_and_related_products["2022/"][1:length(Chemicals_and_related_products["2022/"])]))/sum(Chemicals_and_related_products["2022/"][1:length(Chemicals_and_related_products["2023/"])])
YTD_Pharma_text<-conditional(YTD_Pharma)



Pharma_Share_2020<- sum(Chemicals_and_related_products["2022"][1:length(Total_Export_Country$TOTAL["2023"])])/(sum(Total_Export_Country$TOTAL["2022"][1:length(Total_Export_Country$TOTAL["2023"])]))
...
product_contribution<-ggplot(data=summary_contribution_melt_Product, aes(y=value, x=Date, fill=variable)) + 
  geom_bar(position="stack", stat="identity")+theme(legend.position='bottom',plot.caption = element_text(hjust=0))+
  labs(x="",
       title="Ireland Export Contribution to Growth",
       caption="Date Source: CSO monthly external trade data from 2020",
       y="Percentage Share (%)")+
...
```
 ...
 <span class="text-center" style="color:#A3915E"> <center> <font size="4">   **Goods Imports -Detailed Breakdown** </font>  </center> </span>
...
destination_plot_imports+theme(legend.position =c(0.2,0.8))
```

#### **Country Level Breakdown** ####

* Imports from the USA, `r text_annual_import_USA` on an annual basis and
contributed `r round(Contribution_annual_growth_Import$USA[length(Contribution_annual_growth_Import$USA)],1)`
percentage points (representing `r text_annual_contribution_import_USA_TOTAL`
of the total) in `r current_date`.
<br>
<br>
* Imports from Great Britian, `r text_annual_import_GB` on an annual basis and
contributed `r round(Contribution_annual_growth_Import$GB[length(Contribution_annual_growth_Import$GB)],1)`
percentage points (representing `r text_annual_contribution_import_GB_TOTAL` of
the total) in `r current_date`.
<br>
<br>
* Imports from Northern Ireland, `r text_annual_import_NI` on an annual basis
and contributed `r round(Contribution_annual_growth_Import$NI[length(Contribution_annual_growth_Import$NI)],1)`
percentage points (representing `r text_annual_contribution_import_NI_TOTAL` of
the total) in `r current_date`.
<br>
<br>
* Imports from Germany, `r text_annual_import_Germany` on an annual basis and
contributed `r round(Contribution_annual_growth_Import$Germany[length(Contribution_annual_growth_Import$Germany)],1)`
percentage points (representing `r text_annual_contribution_import_Germany_TOTAL` of the total) in 
`r current_date`.
<br>
<br>
* Imports from Switzerland, `r text_annual_import_Switzerland` on an annual basis and contributed 
`r round(Contribution_annual_growth_Import$Switzerland[length(Contribution_annual_growth_Import$Switzerland)],1)`
percentage points (representing `r text_annual_contribution_import_Switzerland_TOTAL` of the total)
in `r current_date`.
<br>
<br>
* Outside of our main trading partners,imports `r text_annual_import_Other` on
an annual basis and contributed `r round(Other_contribution_import$TOTAL[length(Other_contribution_import$TOTAL)],1)`
percentage points (representing `r text_annual_contribution_import_Other_TOTAL`
of the total) in `r current_date`.
...
dataset_names <- list('Annual Export -Country'=Contribution_annual_growth_DF,' Annual Export -Product' =Contribution_Prod_CON_DF,'Annual Import -Country'=Contribution_annual__IMPORT_growth_DF)
...
Ireland_72821 <-read_table2("https://ec.europa.eu/eurostat/api/comext/dissemination/sdmx/2.1/data/DS-018995/M.IE.EU27_2020_EXTRA+EU27_2020_INTRA+WORLD.TOTAL+72821.1+2.VALUE_IN_EUROS/?format=TSV&startPeriod=1988-01&endPeriod=2023-12")

Ireland_72821_EXPORT<-t(data.frame(Ireland_72821[10,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72821[9,])))) 

Ireland_72821_IMPORT<-t(data.frame(Ireland_72821[9,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72821[9,]))))

Ireland_72821_NET_TRADE<-Ireland_72821_EXPORT-Ireland_72821_IMPORT



Ireland_72822 <-read_table2("https://ec.europa.eu/eurostat/api/comext/dissemination/sdmx/2.1/data/DS-018995/M.IE.EU27_2020_EXTRA+EU27_2020_INTRA+WORLD.TOTAL+72822.1+2.VALUE_IN_EUROS/?format=TSV&startPeriod=1988-01&endPeriod=2023-12")

Ireland_72822_EXPORT<-t(data.frame(Ireland_72822[10,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72822[9,])))) 

Ireland_72822_IMPORT<-t(data.frame(Ireland_72822[9,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72822[9,]))))
...
Ireland_72829 <-read_table2("https://ec.europa.eu/eurostat/api/comext/dissemination/sdmx/2.1/data/DS-018995/M.IE.EU27_2020_EXTRA+EU27_2020_INTRA+WORLD.TOTAL+72822.1+2.VALUE_IN_EUROS/?format=TSV&startPeriod=1988-01&endPeriod=2023-12")

Ireland_72829_EXPORT<-t(data.frame(Ireland_72829[10,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))

Ireland_72829_IMPORT<-t(data.frame(Ireland_72829[9,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))

Ireland_72829_NET_TRADE<-Ireland_72829_EXPORT-Ireland_72829_IMPORT 


#Commercial Vehicles 
Ireland_782 <-read_table2("https://ec.europa.eu/eurostat/api/comext/dissemination/sdmx/2.1/data/DS-018995/M.IE.EU27_2020_EXTRA+EU27_2020_INTRA+WORLD.TOTAL+782.1+2.VALUE_IN_EUROS/?format=TSV&startPeriod=1988-01&endPeriod=2023-12")


Ireland_782_EXPORT<-t(data.frame(Ireland_782[10,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))

Ireland_782_IMPORT<-t(data.frame(Ireland_782[9,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))

Ireland_782_NET_TRADE<-Ireland_782_EXPORT-Ireland_782_IMPORT 

#Road Vehicles NES
Ireland_783 <-read_table2("https://ec.europa.eu/eurostat/api/comext/dissemination/sdmx/2.1/data/DS-018995/M.IE.EU27_2020_EXTRA+EU27_2020_INTRA+WORLD.TOTAL+783.1+2.VALUE_IN_EUROS/?format=TSV&startPeriod=1988-01&endPeriod=2023-12")


Ireland_783_EXPORT<-t(data.frame(Ireland_783[10,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))

Ireland_783_IMPORT<-t(data.frame(Ireland_783[9,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))

Ireland_783_NET_TRADE<-Ireland_783_EXPORT-Ireland_783_IMPORT 


#Railway Vehicles NES
Ireland_791 <-read_table2("https://ec.europa.eu/eurostat/api/comext/dissemination/sdmx/2.1/data/DS-018995/M.IE.EU27_2020_EXTRA+EU27_2020_INTRA+WORLD.TOTAL+791.1+2.VALUE_IN_EUROS/?format=TSV&startPeriod=1988-01&endPeriod=2023-12")


Ireland_791_EXPORT<-t(data.frame(Ireland_791[10,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))

Ireland_791_IMPORT<-t(data.frame(Ireland_791[9,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))
...
#SHIPS/BOATS
Ireland_793 <-read_table2("https://ec.europa.eu/eurostat/api/comext/dissemination/sdmx/2.1/data/DS-018995/M.IE.EU27_2020_EXTRA+EU27_2020_INTRA+WORLD.TOTAL+793.1+2.VALUE_IN_EUROS/?format=TSV&startPeriod=1988-01&endPeriod=2023-12")


Ireland_793_EXPORT<-t(data.frame(Ireland_793[10,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))

Ireland_793_IMPORT<-t(data.frame(Ireland_793[9,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))
...
Ireland_76 <-read_table2("https://ec.europa.eu/eurostat/api/comext/dissemination/sdmx/2.1/data/DS-018995/M.IE.EU27_2020_EXTRA+EU27_2020_INTRA+WORLD.TOTAL+76.1+2.VALUE_IN_EUROS/?format=TSV&startPeriod=1988-01&endPeriod=2023-12")


Ireland_76_EXPORT<-t(data.frame(Ireland_76[10,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))

Ireland_76_IMPORT<-t(data.frame(Ireland_76[9,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))

Ireland_76_NET_TRADE<-Ireland_76_EXPORT-Ireland_76_IMPORT 


#LAPTOP 
Ireland_7522 <-read_table2("https://ec.europa.eu/eurostat/api/comext/dissemination/sdmx/2.1/data/DS-018995/M.IE.EU27_2020_EXTRA+EU27_2020_INTRA+WORLD.TOTAL+7522.1+2.VALUE_IN_EUROS/?format=TSV&startPeriod=1988-01&endPeriod=2023-12")


Ireland_7522_EXPORT<-t(data.frame(Ireland_7522[10,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))

Ireland_7522_IMPORT<-t(data.frame(Ireland_7522[9,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))
...
#AGRI Machinery 
Ireland_721 <-read_table2("https://ec.europa.eu/eurostat/api/comext/dissemination/sdmx/2.1/data/DS-018995/M.IE.EU27_2020_EXTRA+EU27_2020_INTRA+WORLD.TOTAL+721.1+2.VALUE_IN_EUROS/?format=TSV&startPeriod=1988-01&endPeriod=2023-12")


Ireland_721_EXPORT<-t(data.frame(Ireland_721[10,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))

Ireland_721_IMPORT<-t(data.frame(Ireland_721[9,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))
...
#TRACTORS 
Ireland_722 <-read_table2("https://ec.europa.eu/eurostat/api/comext/dissemination/sdmx/2.1/data/DS-018995/M.IE.EU27_2020_EXTRA+EU27_2020_INTRA+WORLD.TOTAL+722.1+2.VALUE_IN_EUROS/?format=TSV&startPeriod=1988-01&endPeriod=2023-12")


Ireland_722_EXPORT<-t(data.frame(Ireland_722[10,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))

Ireland_722_IMPORT<-t(data.frame(Ireland_722[9,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))
...
Ireland_727 <-read_table2("https://ec.europa.eu/eurostat/api/comext/dissemination/sdmx/2.1/data/DS-018995/M.IE.EU27_2020_EXTRA+EU27_2020_INTRA+WORLD.TOTAL+727.1+2.VALUE_IN_EUROS/?format=TSV&startPeriod=1988-01&endPeriod=2023-12")


Ireland_727_EXPORT<-t(data.frame(Ireland_727[10,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))

Ireland_727_IMPORT<-t(data.frame(Ireland_727[9,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))
...
Ireland_73 <-read_table2("https://ec.europa.eu/eurostat/api/comext/dissemination/sdmx/2.1/data/DS-018995/M.IE.EU27_2020_EXTRA+EU27_2020_INTRA+WORLD.TOTAL+73.1+2.VALUE_IN_EUROS/?format=TSV&startPeriod=1988-01&endPeriod=2023-12")


Ireland_73_EXPORT<-t(data.frame(Ireland_73[10,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))

Ireland_73_IMPORT<-t(data.frame(Ireland_73[9,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))
...
Ireland_71 <-read_table2("https://ec.europa.eu/eurostat/api/comext/dissemination/sdmx/2.1/data/DS-018995/M.IE.EU27_2020_EXTRA+EU27_2020_INTRA+WORLD.TOTAL+71.1+2.VALUE_IN_EUROS/?format=TSV&startPeriod=1988-01&endPeriod=2023-12")


Ireland_71_EXPORT<-t(data.frame(Ireland_71[10,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))

Ireland_71_IMPORT<-t(data.frame(Ireland_71[9,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))

Ireland_71_NET_TRADE<-Ireland_71_EXPORT-Ireland_71_IMPORT 


#TURBOJET  ETC 
Ireland_7144 <-read_table2("https://ec.europa.eu/eurostat/api/comext/dissemination/sdmx/2.1/data/DS-018995/M.IE.EU27_2020_EXTRA+EU27_2020_INTRA+WORLD.TOTAL+7144.1+2.VALUE_IN_EUROS/?format=TSV&startPeriod=1988-01&endPeriod=2023-12")


Ireland_7144_EXPORT<-t(data.frame(Ireland_7144[10,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))

Ireland_7144_IMPORT<-t(data.frame(Ireland_7144[9,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))
...
#PARTS OF ENGINES  
Ireland_7149 <-read_table2("https://ec.europa.eu/eurostat/api/comext/dissemination/sdmx/2.1/data/DS-018995/M.IE.EU27_2020_EXTRA+EU27_2020_INTRA+WORLD.TOTAL+7149.1+2.VALUE_IN_EUROS/?format=TSV&startPeriod=1988-01&endPeriod=2023-12")


Ireland_7149_EXPORT<-t(data.frame(Ireland_7149[10,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))

Ireland_7149_IMPORT<-t(data.frame(Ireland_7149[9,])) %>% as.numeric() %>% as.xts(order.by=as.Date(seq(as.Date("1998-12-01"), by="month",length.out=length(Ireland_72829[9,]))))
...
DOMESTIC_ME_IMPORTS_SHORT<-DOMESTIC_ME_IMPORTS[260:nrow((DOMESTIC_ME_IMPORTS)),]
...
SEMICON_NET_IMPORT_GRAPH<-ggplot(SEMI_NET_IMPORTS[260:nrow(SEMI_NET_IMPORTS),],aes(Date,SEMI_NET_IMPORTS/1000000)) + 
  geom_col(fill=DOF_colours[2],colour=DOF_colours[2])+theme(legend.position='bottom',element_text(size=100))+
  labs(x="",
...
YTD_SEMI_NET_IMPORTS<- 100*((sum(as.numeric(na.omit(SEMI_NET_IMPORTS_XTS$SEMI_NET_IMPORTS.SEMI_NET_IMPORTS["2023"])))-(sum(as.numeric(SEMI_NET_IMPORTS_XTS$SEMI_NET_IMPORTS.SEMI_NET_IMPORTS["2022"])[1:length(na.omit(SEMI_NET_IMPORTS_XTS$SEMI_NET_IMPORTS.SEMI_NET_IMPORTS["2023"]))])))/(sum(as.numeric(SEMI_NET_IMPORTS_XTS$SEMI_NET_IMPORTS.SEMI_NET_IMPORTS["2022"])[1:length(na.omit(SEMI_NET_IMPORTS_XTS$SEMI_NET_IMPORTS.SEMI_NET_IMPORTS["2023"]))]))) 
...
YTD_DOMESTIC_ME_NET_IMPORTS<- 100*((sum(as.numeric(na.omit(DOMESTIC_ME_IMPORTS_SUM_XTS$.["2023"])))-(sum(as.numeric(DOMESTIC_ME_IMPORTS_SUM_XTS$.["2022"])[1:length(na.omit(DOMESTIC_ME_IMPORTS_SUM_XTS$.["2023"]))])))/(sum(as.numeric(DOMESTIC_ME_IMPORTS_SUM_XTS$.["2022"])[1:length(na.omit(DOMESTIC_ME_IMPORTS_SUM_XTS$.["2023"]))]))) 
...
* The net import of machinery used to develop semiconductors `r conditional(SEMI_TEXT_GROWTH)` on an annual basis in `r SEMI_TEXT_MONTH`, with net imports of `r SEMI_TEXT_VALUE` million. 
<br>
<br>
...
DOMESTIC_ME_IMPORTS_plot+ theme(legend.position=c(0.2, 0.8))
